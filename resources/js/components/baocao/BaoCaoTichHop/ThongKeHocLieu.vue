...
export default {
    ...
    methods : {
        onExport(){
            ...
            let uri = '/csdlgd-report-api/K12/baoCaoHocLieu';
            let params = {
                "day" : '24/8/2022',
                dataType : 'byYear'
        ...
        dowloadFile(data){
            ...
            sheet.getCell('A3').value = 'BÁO CÁO THỐNG KÊ HỌC LIỆU'
            ...
            let header;
            header = ['STT','Tên trường','Bài giảng','Bài kiểm tra','Lớp học ảo','Kế hoạch bài dạy','Đề thi','Cuộc họp'];
            ...
            data.forEach((item,index) => {
                let dataRow = [
                    ...
                    item.title || '',
                    item.testByYear || 0,
                    item.onlineConferenceByYear || 0,
                    item.lessonPlanByYear || 0,
                    item.examByYear || 0,
            ...
            wb.xlsx.writeBuffer().then(function(data){
                ...
                anchor.href = url;
                anchor.download = 'ThongKeHocLieu.xlsx';
                anchor.click();
