        ...
        <div class="modal-dialog" style="width: 100%; margin: 0 auto !important;">
            <div class="modal-content">
                ...
                <div class="modal-header" style="position: relative">
                    <button type="button" class="close btn btn-danger" style="position: absolute; top: 2px; right: 2px;"
                        data-dismiss="modal" aria-hidden="true" v-on:click="close()">
                        &times;
                    </button>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div v-if="thongtin.role!=5">
                                <div v-if="this.thongtin.role==2||this.thongtin.role==3">
                                    <multiselect v-model="danhSachDonVi" :options="list_don_vi" :multiple="true"
                                        @close="ChonDonVi()" :close-on-select="false" :clear-on-select="false"
                                        ...
                                        label="maDonVi" track-by="tenDonVi" :preselect-first="true">
                                ...
                                <div v-else="v-else">
                                    <input class="form-control" type="text" :value="thongtin.display_name"
                                        disabled="disabled" />
                                </div>
                            </div>
                            <div v-if="thongtin.role==5">
                                <input :disabled="thongtin.role == 5" class="form-control"
                                    placeholder="Nhập..." />
                            </div>
                        ...
                        <div class="col-md-4 timkiem">
                            ...
                            <div v-if="thongtin.role!=5">
                                <multiselect v-model="danhSachTruongHoc" :options="list_truong_hoc" :multiple="true"
                                    @close="ChonTruongHoc()" :close-on-select="false" :clear-on-select="false"
                                    :preserve-search="false" deselectLabel="Đã chọn" selectLabel="Chưa chọn"
                                    selectedLabel="Đã chọn" :custom-label="setNameTruongHoc"
                                    placeholder="Chọn trường học" label="maTruongHoc" track-by="tenTruongHoc"
                            ...
                            <div v-if="thongtin.role==5">
                                <input :disabled="thongtin.role == 5" class="form-control"
                                    :value="this.thongtin.display_name" placeholder="Nhập..." />
                            </div>
                            <!-- <pre class="language-json"><code>{{ danhSachDonVi }}</code></pre> -->
                        </div>
                        <div class="col-md-2 timkiem">
                            <label class="typo__label">Năm học</label>
                            <multiselect v-model="danhSachNamHoc" :options="list_nam_hoc" @close="ChonNamHoc()"
                                :custom-label="setNameNamHoc" placeholder="Chọn năm học" label="name"
                                deselectLabel="Đã chọn" selectLabel="Chưa chọn" selectedLabel="Đã chọn" track-by="name">
                            </multiselect>
                        </div>
                        <div class="col-md-2 timkiem">
                            <label class="typo__label">Học kỳ: <span style="color:#DC0101">*</span></label>
