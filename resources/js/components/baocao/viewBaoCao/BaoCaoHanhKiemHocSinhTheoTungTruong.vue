<template>
    <div id="BcHanhKiemHocSinh" ref="BcHanhKiemHocSinh" class="modal fade giam-han">
                                        ...
                                        <div v-if="capHoc==1" class="xembaocao form-group clearfix">
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th colspan="48" class="text-uppercase red text-center">
                                                            <h3>
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        ...
                                                        <th class="cg text-center" colspan="9">Lớp 1</th>
                                                        <th class="cg text-center" colspan="9">Lớp 2</th>
                                                        <th class="cg text-center" colspan="9">Lớp 3</th>
                                                        <th class="cg text-center" colspan="9">Lớp 4</th>
                                                        <th class="cg text-center" colspan="9">Lớp 5</th>
                                                    </tr>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th colspan="33" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="6" class="tn vh">
                                                            <b>{{TieuDe.tenDonVi}}</b>
                                                        </th>
                                                        <th colspan="33" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                    </tr>
                                                    <tr>
                                                        <th></th>
                                                        <th></th>
                                                    ...
                                                    <tr>
                                                        <th colspan="39" class="text-uppercase red text-center">
                                                            <h3>
                                                                {{TieuDe.reportTitle}}</h3>
                                                        </th>
                                                    </tr>
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        ...
                                                        <th class="cg text-center" rowspan="3">Trường</th>
                                                        <th class="cg text-center" rowspan="3">Tổng</th>
                                                        <th class="cg text-center" colspan="9">Lớp 6</th>
                                                        <th class="cg text-center" colspan="9">Lớp 7</th>
                                                        <th class="cg text-center" colspan="9">Lớp 8</th>
                                                        <th class="cg text-center" colspan="9">Lớp 9</th>
                                                    </tr>
                                                    <tr style="background: #f9f9f9">
                                                        <th rowspan="2" class="cg text-center">Tổng</th>
                                                        <th class="cg text-center" colspan="2">Tốt</th>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        ...
                                                        <th class="cg text-center" rowspan="3">Trường</th>
                                                        <th class="cg text-center" rowspan="3">Tổng</th>
                                                        <th class="cg text-center" colspan="9">Lớp 10</th>
                                                        <th class="cg text-center" colspan="9">Lớp 11</th>
                                                        <th class="cg text-center" colspan="9">Lớp 12</th>
                                                    </tr>
                                                    <tr style="background: #f9f9f9">
                                                        <th rowspan="2" class="cg text-center">Tổng</th>
                                                        <th class="cg text-center" colspan="2">Tốt</th>
            ...
            export default {
                ...
                watch: {
                    show: function (newVal, oldVal) {
                        if (newVal) {
                            $("#BcHanhKiemHocSinh").modal();
                        } else {
                            $("#BcHanhKiemHocSinh").modal('hide');
                        }
                    },
                ...
                mounted: function () {
                    this.namHoc = this
                        .date
                        .getFullYear();
                    $(this.$refs.BcHanhKiemHocSinh).on("hidden.bs.modal", this.close)
                ...
                methods: {
                    ...
                    getData() {
                        if (this.namHoc == "" || this.hocKy == '' || this.capHoc == "" || this.madonvi == "") {
