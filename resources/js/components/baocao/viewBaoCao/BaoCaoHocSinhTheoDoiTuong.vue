<template>
    <div
        id="BcSoLuongHocSinhTheoDoiTuong"
        ref="BcSoLuongHocSinhTheoDoiTuong"
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="25" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7" class="tn vh">
                                                        <b>{{TieuDe.tenDonVi}}</b>
                                                    </th>
                                                    <th colspan="25" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <th colspan="32" class="text-uppercase red text-center">
                                                        <h3>
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    ...
                                                    <th class="cg text-center" colspan="6">Khối 1</th>
                                                    <th class="cg text-center" colspan="6">Khối 2</th>
                                                    <th class="cg text-center" colspan="6">Khối 3</th>
                                                    <th class="cg text-center" colspan="6">Khối 4</th>
                                                    <th class="cg text-center" colspan="6">Khối 5</th>
                                                </tr>
                                                ...
                                                <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                    ...
                                                    <template v-for="ctlh in ctbc.khoiLopList">
                                                        <td>{{ctlh.tongSoHocSinh}}</td>
                                                        <td>{{ctlh.tongSoLop}}</td>
                                                        <td>{{ctlh.soHocSinhNu}}</td>
                                                        <td>{{ctlh.soHocSinhDanToc}}</td>
                                                        <td>{{ctlh.soHocSinhChinhSach}}</td>
                                                        <td>{{ctlh.soHocSinhUuTien}}</td>
                                                    </template>
                                                </tr>
                                                <tr style="background: white;">
                                                    <td colspan="2">Tổng:</td>
                                                    <template v-for="ts in TieuDe.tongSo.khoiLopList">
                                                        <td>{{ts.tongSoHocSinh}}</td>
                                                        <td>{{ts.tongSoLop}}</td>
                                                        <td>{{ts.soHocSinhNu}}</td>
                                                        <td>{{ts.soHocSinhDanToc}}</td>
                                                        <td>{{ts.soHocSinhChinhSach}}</td>
                                                        <td>{{ts.soHocSinhUuTien}}</td>
                                                    </template>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="20" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="6" class="tn vh">
                                                        <b>{{TieuDe.tenDonVi}}</b>
                                                    </th>
                                                    <th colspan="20" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <th colspan="26" class="text-uppercase red text-center">
                                                        <h3>
                                                            {{TieuDe.reportTitle}}</h3>
                                                    </th>
                                                </tr>
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    <th class="cg text-center" rowspan="2">STT</th>
                                                    <th class="cg text-center" rowspan="2">Trường</th>
                                                    <th class="cg text-center" colspan="6">Khối 6</th>
                                                    <th class="cg text-center" colspan="6">Khối 7</th>
                                                    <th class="cg text-center" colspan="6">Khối 8</th>
                                                    <th class="cg text-center" colspan="6">Khối 9</th>
                                                </tr>
                                                <tr style="background:#f9f9f9">
                                                    <th>Số HS</th>
                                                    <th>Số lớp</th>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="13" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7" class="tn vh">
                                                        <b>{{TieuDe.tenDonVi}}</b>
                                                    </th>
                                                    <th colspan="13" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    <th class="cg text-center" rowspan="2">STT</th>
                                                    <th class="cg text-center" rowspan="2">Trường</th>
                                                    <th class="cg text-center" colspan="6">Khối 10</th>
                                                    <th class="cg text-center" colspan="6">Khối 11</th>
                                                    <th class="cg text-center" colspan="6">Khối 12</th>
                                                </tr>
                                                <tr style="background:#f9f9f9">
                                                    <th>Số HS</th>
                                                    <th>Số lớp</th>
        ...
        export default {
            ...
            watch: {
                show: function (newVal, oldVal) {
                    if (newVal) {
                        $("#BcSoLuongHocSinhTheoDoiTuong").modal();
                    } else {
                        $("#BcSoLuongHocSinhTheoDoiTuong").modal('hide');
                    }
                },
            ...
            mounted: function () {
                this.namHoc = this
                    .date
                    .getFullYear();
                $(this.$refs.BcSoLuongHocSinhTheoDoiTuong).on("hidden.bs.modal", this.close);
