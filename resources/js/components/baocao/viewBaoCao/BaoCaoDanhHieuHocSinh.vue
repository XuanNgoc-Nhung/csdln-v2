<template>
    <div id="BcDanhHieuHocSinh" ref="BcDanhHieuHocSinh" class="modal fade giam-han">
                ...
                <div class="modal-header" style="position: relative">
                    ...
                    <div class="modal-body clearfix">
                        <div style="padding-top: 10px">
                            ...
                            <!-- <div v-if="Report.length" class="row"> <div class="col-md-12"> <div
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th colspan="21" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                    </tr>
                                                    <tr>
                                                        <th colspan="6" class="tn vh">
                                                            <b>{{TieuDe.tenDonVi}}</b>
                                                        </th>
                                                        <th colspan="21" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                    </tr>
                                                    <tr>
                                                        <th></th>
                                                        <th></th>
                                                    ...
                                                    <tr>
                                                        <th colspan="27" class="text-uppercase red text-center">
                                                            <h3>
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        ...
                                                        <th class="cg text-center" colspan="5">Lớp 1</th>
                                                        <th class="cg text-center" colspan="5">Lớp 2</th>
                                                        <th class="cg text-center" colspan="5">Lớp 3</th>
                                                        <th class="cg text-center" colspan="5">Lớp 4</th>
                                                        <th class="cg text-center" colspan="5">Lớp 5</th>
                                                    </tr>
                                                    <tr style="background:#f9f9f9">
                                                        <th class="cg text-center" rowspan="2">Tổng số</th>
                                                        <th class="cg text-center" colspan="2">HS Tiên tiến</th>
                                                        <th class="cg text-center" colspan="2">HS Giỏi</th>
                                                        <th class="cg text-center" rowspan="2">Tổng số</th>
                                                        <th class="cg text-center" colspan="2">HS Tiên tiến</th>
                                                        <th class="cg text-center" colspan="2">HS Giỏi</th>
                                                        <th class="cg text-center" rowspan="2">Tổng số</th>
                                                    ...
                                                    <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                        ...
                                                        <template v-for="ctlh in ctbc.khoiLopList">
                                                            <td>{{ctlh.tongSo}}</td>
                                                            <td>
                                                                <div v-if="ctlh.soLuongTienTien">
                                                                    {{ctlh.soLuongTienTien}}
                                                                </div>
                                                                <div v-else="v-else">0</div>
                                                            </td>
                                                            <td>
                                                                <div v-if="ctlh.tiLeTienTien">
                                                                    {{ctlh.tiLeTienTien}}%
                                                                </div>
                                                                <div v-else="v-else">0%</div>
                                                            </td>
                                                            <td>
                                                                <div v-if="ctlh.soLuongGioi">
                                                                    {{ctlh.soLuongGioi}}
                                                                </div>
                                                                <div v-else="v-else">0</div>
                                                            </td>
                                                            <td>
                                                                <div v-if="ctlh.tiLeGioi">
                                                                    {{ctlh.tiLeGioi}}%
                                                                </div>
                                                                <div v-else="v-else">0%</div>
                                                            </td>
                                                    ...
                                                    <tr style="background: white;">
                                                        ...
                                                        <template v-for="ts in TieuDe.tongSo.khoiLopList">
                                                            <td>{{ts.tongSo}}</td>
                                                            <td>{{ts.soLuongTienTien}}</td>
                                                            <td>{{ts.tiLeTienTien}}%</td>
                                                            <td>{{ts.soLuongGioi}}</td>
                                                            <td>{{ts.tiLeGioi}}%</td>
                                                        </template>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        <th class="cg text-center" rowspan="3">STT</th>
                                                        <th class="cg text-center" rowspan="3">Tên trường</th>
                                                        <th class="cg text-center" colspan="5">Lớp 6</th>
                                                        <th class="cg text-center" colspan="5">Lớp 7</th>
                                                        <th class="cg text-center" colspan="5">Lớp 8</th>
                                                        <th class="cg text-center" colspan="5">Lớp 9</th>
                                                    </tr>
                                                    <tr style="background:#f9f9f9">
                                                        <th class="cg text-center" rowspan="2">Tổng số</th>
                                                        <th class="cg text-center" colspan="2">HS Tiên tiến</th>
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody class="noidung">
                                                    <tr>
                                                        <th class="cg text-center" rowspan="3">STT</th>
                                                        <th class="cg text-center" rowspan="3">Tên trường</th>
                                                        <th class="cg text-center" colspan="5">Lớp 10</th>
                                                        <th class="cg text-center" colspan="5">Lớp 11</th>
                                                        <th class="cg text-center" colspan="5">Lớp 12</th>
                                                    </tr>
                                                    <tr style="background:#f9f9f9">
                                                        <th class="cg text-center" rowspan="2">Tổng số</th>
                                                        <th class="cg text-center" colspan="2">HS Tiên tiến</th>
            ...
            export default {
                ...
                watch: {
                    show: function (newVal, oldVal) {
                        if (newVal) {
                            $("#BcDanhHieuHocSinh").modal();
                        } else {
                            $("#BcDanhHieuHocSinh").modal('hide');
                        }
                    },
                ...
                mounted: function () {
                    this.namHoc = this
                        .date
                        .getFullYear();
                    $(this.$refs.BcDanhHieuHocSinh).on("hidden.bs.modal", this.close);
