                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="noidung">
                                                ...
                                                <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                    ...
                                                    <td class="text-center">
                                                        <p>{{ctbc.tongSoTreNhaTre}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre3Den12Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre13Den24Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre25Den36Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.tongSoTreMauGiao}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre3Den4Tuoi}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre4Den5Tuoi}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{ctbc.soTre5Den6Tuoi}}</p>
                                                    </td>
                                                </tr>
                                                <tr style="background: white;">
                                                    <td colspan="2">Tổng cộng:</td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.tongSoTre}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.tongSoTreNhaTre}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre3Den12Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre13Den24Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre25Den36Thang}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.tongSoTreMauGiao}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre3Den4Tuoi}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre4Den5Tuoi}}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p>{{tongSo.soTre5Den6Tuoi}}</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
