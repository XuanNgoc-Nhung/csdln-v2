<template>
    <div id="BcCanBoTheoDoTuoi" ref="BcCanBoTheoDoTuoi" class="modal fade giam-han">
        <div
            class="modal-dialog"
            style="width: 90%; margin: 0 auto !important;height:85vh;">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th colspan="8" class="qh">Độc lập - Tự do - Hạnh phúc</th>
                                                    </tr>
                                                    <tr>
                                                        <th></th>
                                                        <th></th>
                                                    ...
                                                    <tr>
                                                        <th colspan="11" class="text-uppercase red text-center">
                                                            <h3>
                                                ...
                                                <tbody class="noidung">
                                                    ...
                                                    <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                        ...
                                                        <td>{{ctbc.duoi31}}</td>
                                                        <td>{{ctbc.tu31den35}}</td>
                                                        <td>{{ctbc.tu36den40}}</td>
                                                        <td>{{ctbc.tu41den45}}</td>
                                                        <td>{{ctbc.tu46den50}}</td>
                                                        <td>{{ctbc.tu51den55}}</td>
                                                        <td>{{ctbc.tu56den60}}</td>
                                                        <td>{{ctbc.tren60}}</td>
                                                    </tr>
                                                    <tr style="background: white;">
                                                        <td colspan="2">Tổng cộng:</td>
                                                        <td>{{TieuDe.tongSo.soLuongTong}}</td>
                                                        <td>{{TieuDe.tongSo.duoi31}}</td>
                                                        <td>{{TieuDe.tongSo.tu31den35}}</td>
                                                        <td>{{TieuDe.tongSo.tu36den40}}</td>
                                                        <td>{{TieuDe.tongSo.tu41den45}}</td>
                                                        <td>{{TieuDe.tongSo.tu46den50}}</td>
                                                        <td>{{TieuDe.tongSo.tu51den55}}</td>
                                                        <td>{{TieuDe.tongSo.tu56den60}}</td>
                                                        <td>{{TieuDe.tongSo.tren60}}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
            ...
            export default {
                ...
                watch: {
                    show: function (newVal, oldVal) {
                        if (newVal) {
                            $("#BcCanBoTheoDoTuoi").modal();
                        } else {
                            $("#BcCanBoTheoDoTuoi").modal('hide');
                        }
                    },
                ...
                mounted: function () {
                    this.namHoc = this
                        .date
                        .getFullYear();
                    $(this.$refs.BcCanBoTheoDoTuoi).on("hidden.bs.modal", this.close);
