<template>
    <div id="BcSoLuongHocSinh" ref="BcSoLuongHocSinh" class="modal fade giam-han">
            ...
            <div class="modal-content">
                <div class="modal-header" style="position: relative">
                    ...
                    <div class="modal-body clearfix">
                        ...
                        <div style="padding-top: 10px">
                            <div v-if="Report.length>0" id="baoCaoSoLuongHocSinhCap2" class="text-center">
                                <div v-if="pdf">
                                    <div class="row">
                                        <div class="col-lg-12">
                                    ...
                                    <div v-if="capHoc==1" class="xembaocao form-group clearfix">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th colspan="18" class="text-uppercase red text-center">
                                                        <h3>
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    ...
                                                    <th class="cg text-center" colspan="3">Lớp 1</th>
                                                    <th class="cg text-center" colspan="3">Lớp 2</th>
                                                    <th class="cg text-center" colspan="3">Lớp 3</th>
                                                    <th class="cg text-center" colspan="3">Lớp 4</th>
                                                    <th class="cg text-center" colspan="3">Lớp 5</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Số học sinh</th>
                                                ...
                                                <tr style="background: #f9f9f9">
                                                    <th>Học sinh dân tộc</th>
                                                    <th>Học sinh khuyết tật</th>
                                                    <th>Học sinh dân tộc</th>
                                                    <th>Học sinh khuyết tật</th>
                                                    <th>Học sinh dân tộc</th>
                                                    <th>Học sinh khuyết tật</th>
                                                ...
                                                <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                    ...
                                                    <template v-for="ctlh in ctbc.khoiLopList">
                                                        <td>{{ctlh.soHocSinhKhoi}}</td>
                                                        <td>{{ctlh.hsDanToc}}</td>
                                                        <td>{{ctlh.hsKhuyetTat}}</td>
                                                    </template>
                                                </tr>
                                                <tr style="background: white;">
                                                    ...
                                                    <template v-for="ts in TieuDe.tongSo.khoiLopList">
                                                        <td>{{ts.soHocSinhKhoi}}</td>
                                                        <td>{{ts.hsDanToc}}</td>
                                                        <td>{{ts.hsKhuyetTat}}</td>
                                                    </template>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    ...
                                                    <th class="cg text-center" rowspan="3">Tên trường</th>
                                                    <th class="cg text-center" rowspan="3">Tổng</th>
                                                    <th class="cg text-center" colspan="3">Lớp 6</th>
                                                    <th class="cg text-center" colspan="3">Lớp 7</th>
                                                    <th class="cg text-center" colspan="3">Lớp 8</th>
                                                    <th class="cg text-center" colspan="3">Lớp 9</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Số học sinh</th>
                                                    <th class="cg text-center" colspan="2">Trong đó</th>
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    ...
                                                    <th class="cg text-center" rowspan="3">Tên trường</th>
                                                    <th class="cg text-center" rowspan="3">Tổng</th>
                                                    <th class="cg text-center" colspan="3">Lớp 10</th>
                                                    <th class="cg text-center" colspan="3">Lớp 11</th>
                                                    <th class="cg text-center" colspan="3">Lớp 12</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Số học sinh</th>
                                                    <th class="cg text-center" colspan="2">Trong đó</th>
        ...
        export default {
            ...
            watch: {
                show: function (newVal, oldVal) {
                    if (newVal) {
                        $("#BcSoLuongHocSinh").modal();
                    } else {
                        $("#BcSoLuongHocSinh").modal('hide');
                    }
                },
            ...
            mounted: function () {
                this.namHoc = this
                    .date
                    .getFullYear();
                $(this.$refs.BcSoLuongHocSinh).on("hidden.bs.modal", this.close);
