                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody class="noidung">
                                                ...
                                                <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                    <td><p>{{i+1}}</p></td>
                                                    <td><p>{{ctbc.tenTruongHoc}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSo}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTre}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTreKhamDk}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTreCanNang}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTreChieuCao}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTreSuyDd}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTrePIH}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoNhaTreBeoPhi}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiao}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoKhamDk}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoCanNang}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoChieuCao}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoSuyDd}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoPIH}}</p></td>
                                                    <td class="text-center"><p>{{ctbc.tongSoMauGiaoBeoPhi}}</p></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">Tổng cộng:</td>
                                                    <td class="text-center"><p>{{tongSo.tongSo}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTre}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTreKhamDk}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTreCanNang}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTreChieuCao}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTreSuyDd}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTrePIH}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoNhaTreBeoPhi}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiao}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoKhamDk}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoCanNang}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoChieuCao}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoSuyDd}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoPIH}}</p></td>
                                                    <td class="text-center"><p>{{tongSo.tongSoMauGiaoBeoPhi}}</p></td>
                                                </tr>
                                            </tbody>
                                        </table>
