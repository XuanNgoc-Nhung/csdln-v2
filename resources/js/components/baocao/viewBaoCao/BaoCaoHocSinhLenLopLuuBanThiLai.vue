<template>
    <div
        id="BcSoHocSinhLenLopLuuBanThiLai"
        ref="BcSoHocSinhLenLopLuuBanThiLai"
                        ...
                        <div style="padding-top: 10px">
                            <div v-if="Report.length>0" class="text-center">
                                <div v-if="pdf">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <iframe style="width:100%; height:500px" :src="linkPdf"></iframe>
                                        </div>
                                    </div>
                                </div>
                                <div v-else="v-else">
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="27" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="3" class="tn vh">
                                                        <b>{{TieuDe.tenDonVi}}</b>
                                                    </th>
                                                    <th colspan="27" class="qh">Độc lập - Tự do - Hạnh phúc</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <th colspan="30" class="text-uppercase red text-center">
                                                        <h3>
                                            ...
                                            <tbody class="noidung">
                                                <tr style="background: #f9f9f9">
                                                    ...
                                                    <th class="cg text-center" colspan="7">Lớp 6</th>
                                                    <th class="cg text-center" colspan="7">Lớp 7</th>
                                                    <th class="cg text-center" colspan="7">Lớp 8</th>
                                                    <th class="cg text-center" colspan="7">Lớp 9</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Tổng số</th>
                                                    <th class="cg text-center" colspan="2">Lên lớp</th>
                                                    <th class="cg text-center" colspan="2">Thi lại</th>
                                                    <th class="cg text-center" colspan="2">Lưu ban</th>
                                                    <th class="cg text-center" rowspan="2">Tổng số</th>
                                                    <th class="cg text-center" colspan="2">Lên lớp</th>
                                                    <th class="cg text-center" colspan="2">Thi lại</th>
                                                    <th class="cg text-center" colspan="2">Lưu ban</th>
                                                ...
                                                <tr v-for="(ctbc,i) in Report" style="background: white;">
                                                    ...
                                                    <template v-for="ctlh in ctbc.khoiLopList">
                                                        <td>{{ctlh.tongSo}}</td>
                                                        <td>{{ctlh.soLuongLenLop}}</td>
                                                        <td>{{ctlh.tiLeLenLop}}%</td>
                                                        <td>{{ctlh.soLuongLuuBan}}</td>
                                                        <td>{{ctlh.tiLeLuuBan}}%</td>
                                                        <td>{{ctlh.soLuongThiLai}}</td>
                                                        <td>{{ctlh.tiLeThiLai}}%</td>
                                                    </template>
                                                </tr>
                                                <tr style="background: white;">
                                                    ...
                                                    <template v-for="ts in TieuDe.tongSo.khoiLopList">
                                                        <td>{{ts.tongSo}}</td>
                                                        <td>{{ts.soLuongLenLop}}</td>
                                                        <td>{{ts.tiLeLenLop}}%</td>
                                                        <td>{{ts.soLuongLuuBan}}</td>
                                                        <td>{{ts.tiLeLuuBan}}%</td>
                                                        <td>{{ts.soLuongThiLai}}</td>
                                                        <td>{{ts.tiLeThiLai}}%</td>
                                                    </template>
                                                </tr>
                                    ...
                                    <div v-else-if="capHoc==1" class="xembaocao form-group clearfix">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    <th colspan="9" class="tn vh">
                                                        <b>{{TieuDe.tenDonViQuanLy}}</b>
                                                    </th>
                                                    <th colspan="28" class="qh vh">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="9" class="tn vh">
                                                        <b>{{TieuDe.tenDonVi}}</b>
                                                    </th>
                                                    <th colspan="28" class="tn">Độc lập - Tự do - Hạnh phúc</th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                                    <th></th>
                                                ...
                                                <tr>
                                                    <th colspan="37" class="text-uppercase red text-center">
                                                        <h3>
                                                            {{TieuDe.reportTitle}}</h3>
                                                    </th>
                                                </tr>
                                            ...
                                            <tbody class="noidung">
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="3">STT</th>
                                                    <th class="cg text-center" rowspan="3">Trường</th>
                                                    <th class="cg text-center" colspan="7">Lớp 1</th>
                                                    <th class="cg text-center" colspan="7">Lớp 2</th>
                                                    <th class="cg text-center" colspan="7">Lớp 3</th>
                                                    <th class="cg text-center" colspan="7">Lớp 4</th>
                                                    <th class="cg text-center" colspan="7">Lớp 5</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Tổng số</th>
                                                    <th class="cg text-center" colspan="2">Lên lớp</th>
                                    ...
                                    <div v-else-if="capHoc==3" class="xembaocao form-group clearfix">
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody class="noidung">
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="3">STT</th>
                                                    <th class="cg text-center" rowspan="3">Trường</th>
                                                    <th class="cg text-center" colspan="7">Lớp 10</th>
                                                    <th class="cg text-center" colspan="7">Lớp 11</th>
                                                    <th class="cg text-center" colspan="7">Lớp 12</th>
                                                </tr>
                                                <tr style="background: #f9f9f9">
                                                    <th class="cg text-center" rowspan="2">Tổng số</th>
                                                    <th class="cg text-center" colspan="2">Lên lớp</th>
        ...
        export default {
            ...
            watch: {
                show: function (newVal, oldVal) {
                    if (newVal) {
                        $("#BcSoHocSinhLenLopLuuBanThiLai").modal();
                    } else {
                        $("#").modal('hide');
                    }
                },
            ...
            mounted: function () {
                this.namHoc = this
                    .date
                    .getFullYear();
                $(this.$refs.BcSoHocSinhLenLopLuuBanThiLai).on("hidden.bs.modal", this.close);
