<template>
    <div
        ...
        id="BcCanBoCheDoLaoDong"
        ref="BcCanBoCheDoLaoDong">
                ...
                <div class="modal-header" style="position: relative">
                    ...
                    <div class="modal-body clearfix">
                        <div style="padding-top: 10px">
                            ...
                            <!-- <div v-if="Report.length>0" class="row"> <div class="pull-right text-right
                            col-sm-12"> <button @click="exPort()" class="btn btn-success">Xuất
                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th></th>
                                                    <th class="qh vh" colspan="7">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</th>
                                                    <th></th>
                                                </tr>
                                                <tr>
                                                    <th colspan="3" class="tn vh">
                                                    ...
                                                    <th></th>
                                                    <th class="tn" colspan="7">Độc lập - Tự do - Hạnh phúc</th>
                                                    <th></th>
                                                </tr>
                                                <tr>
                                                    <th></th>
                                            ...
                                            <tbody class="noidung">
                                                <tr>
                                                    ...
                                                    <th class="cg text-center" colspan="2">Trong tổng số</th>
                                                </tr>
        ...
        export default {
            ...
            watch: {
                show: function (newVal, oldVal) {
                    if (newVal) {
                        $("#BcCanBoCheDoLaoDong").modal();
                    } else {
                        $("#BcCanBoCheDoLaoDong").modal('hide');
                    }
                },
                ...
                dangnhap: function (newVal) {
                    // this.dangNhap = newVal; this.matinhthanh = newVal.province; this.getDonVi();
                    // this.madonvi = this.dangNhap.ma_don_vi; this.getTruongHoc();
                },
            ...
            mounted: function () {
                this.namHoc = this
                    .date
                    .getFullYear();
                $(this.$refs.BcCanBoCheDoLaoDong).on("hidden.bs.modal", this.close);
