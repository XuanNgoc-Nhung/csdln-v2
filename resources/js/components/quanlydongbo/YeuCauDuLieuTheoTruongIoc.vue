<template>
    <div>
        <Breadcrumb :menu="'Kết chuyển dữ liệu'" :desc="'Kết chuyển dữ liệu lên Ioc'" />
        ...
        <div class="card-bieu-do">
            <el-row :gutter="24">
                <el-col v-if='false' :span="12">
                        <label class="table-name">Danh sách trường kết chuyển dữ liệu lên Ioc</label>
                ...
                <el-col v-if='false' :span="12" class="text-right">
                    ...
                    <el-tooltip content="Xóa dữ liệu" v-if='false' placement="top">
