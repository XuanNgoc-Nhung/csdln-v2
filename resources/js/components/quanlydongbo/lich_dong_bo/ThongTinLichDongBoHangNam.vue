                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <h3 class="modal-title text-uppercase">
                                Thông tin CẤU HÌNH ĐỒNG BỘ DỮ LIỆU</h3>
                        </div>
                        <div class="col-md-4">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" disabled class="form-control" :value="namHocCT">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body" style="width: 90%;margin: 0 auto; font-size: 18px">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <input type="text" v-model="start_dau_nam" class="form-control" disabled>
                    </div>
                        <div class="col-lg-4">
                            <label>Ngày kết thúc</label>
                            <input type="text" v-model="end_dau_nam" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="row row_tp">
                        ...
                        <div class="col-lg-9">
                            <em style="color: gray">Dữ liệu đầu năm bao gồm các dữ liệu về: Học sinh, lớp học, phân công
                                giáo
                                viên</em>
                        </div>
                    </div>
...
<!--                                </div>-->
                            ...
                            <div class="row row_tp" v-for="(k, index) in list_du_lieu_phat_sinh" :key="k.id">
                                ...
                                <div class="col-sm-3">
<!--                                    <date-picker :config="configDatePicker" placeholder="Từ ngày" ref="ngayBatDau"-->
<!--                                                 v-model="k.ngayBatDau" @dp-change=""></date-picker>-->
                                    <input type="text" v-model="k.ngayBatDau" class="form-control" disabled>
                                </div>
                                <div class="col-sm-3">
<!--                                    <date-picker :config="configDatePicker" placeholder="Đến ngày" ref="ngayKetThuc"-->
<!--                                                 v-model="k.ngayKetThuc" @dp-change=""></date-picker>-->
                                    <input type="text" v-model="k.ngayKetThuc" class="form-control" disabled>
                                </div>
                                <div class="col-sm-3">
...
<!--                            <button @click.prevent="onBtnAddNewPhatSinh" class="btn btn-success">Thêm</button>-->
                    ...
                    <div class="row row_tp">
                        ...
                        <div class="col-lg-9">
                            <em style="color: gray">Dữ liệu phát sinh bao gồm các dữ liệu: Điểm, học sinh chuyển lớp,
                                học sinh
                    ...
                    <div class="row row_tp">
                        ...
                        <div class="col-lg-4">
                            <label>Ngày bắt đầu</label>
                            <input type="text" v-model="start_cuoi_nam" class="form-control" disabled>
                        </div>
                        <div class="col-lg-4">
                            <label>Ngày kết thúc</label>
                            <input type="text" v-model="end_cuoi_nam" class="form-control" disabled>
                        </div>
                    </div>
                    <div class="row row_tp">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <em style="color: gray">Dữ liệu cuối năm bao gồm các dữ liệu: Điểm tổng kết, tổng kết học
                                sinh</em>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        watch: {
            ...
            item: function (newVal, oldVal) {
                console.log("Chỉnh sửa hihi:" + JSON.stringify(newVal));
        ...
        mounted: function () {
            ...
            console.log("yyyyyyy"+JSON.stringify(this.item));
            this.getDuLieuPhatSinh();
        },
        ...
        methods: {
            ...
            getDuLieuPhatSinh() {
                ...
                let url = "/csdlgd-admin/yeuCauDongBoTn";
                ...
                rest_api.get(url, params, (response) => {
                    if (response.data.rc === 0) {
                        ...
                        this.namHocTT=this.namHoc+1;
                        this.namHocCT=this.namHoc+"-"+this.namHocTT;
            ...
            checkInputArray() {
                ...
                for (let i = 0; i < this.list_du_lieu_phat_sinh.length; i++) {
                    if (!m_util.checkString(this.list_du_lieu_phat_sinh[i].ngayBatDau)) {
                        this.list_du_lieu_phat_sinh[i].errors.ngayBatDau = "Vui lòng chọn thời gian bắt đầu";
                        this.$refs.ngayBatDau[i].$el.focus();
                        return false;
                    }
                    if (!m_util.checkString(this.list_du_lieu_phat_sinh[i].ngayKetThuc)) {
                        this.list_du_lieu_phat_sinh[i].errors.ngayKetThuc = "Vui lòng chọn thời gian kết thúc";
                        this.$refs.ngayKetThuc[i].$el.focus();
                        return false;
                    }
                }
                return true;
            ...
            onBtnAddClick() {
                ...
                for (let i = 0; i < this.list_du_lieu_phat_sinh.length; i++) {
                    ds.push({
                        ngayBatDau: this.list_du_lieu_phat_sinh[i].ngayBatDau,
                        ngayKetThuc: this.list_du_lieu_phat_sinh[i].ngayKetThuc,
                    })
                }
                ...
                confirmDialog("Bạn muốn chỉnh sửa lịch đồng bộ này chứ ?", "Sửa", () => {
                    ...
                    api.post(url, params, (data) => {
                        ...
                        let msg = m_util.getMessageResponse(data, "Chỉnh sửa lịch đồng bộ thành công", "nội dung mess");
