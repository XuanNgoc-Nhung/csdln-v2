        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>DANH SÁCH CẤU HÌNH ĐẨY DỮ LIỆU HÀNG NĂM</label>
...
<script>
// em để component là sửa mà nhỉ? sao nó lại gọi tới thông tin???

    import Page from '../../ui/PagingCustom';
    import rest_api from '../../../utils/rest_api';
    import array_util from '../../../utils/array_utils';
    import ThemMoiLichDongBo from "./ThemMoiLichDongBoHangNam";
    import ChinhSuaLichDongBo from "./SuaLichDongBoHangNam";
    import ThongTinLichDongBo from "./ThongTinLichDongBoHangNam";
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                rest_api.get("/csdlgd-admin/yeuCauDongBoTn/list", params, (data) => {
            ...
            lockSync(e) {
                ...
                dialog.confirmDialog(
                    ...
                    () => {
                        ...
                        console.log("lấy danh sách cấu hình lịch đồng bộ");
                        rest_api.get("/csdlgd-admin/yeuCauDongBoTn/toggleStatus", params, (data) => {
            ...
            deleteData(qh) {
                ...
                dialog.confirmDialog("Bạn có muốn xóa lịch đồng bộ này?", "Đồng ý", () => {
                    ...
                    const uri = "/api_xoa_lich_dong_bo_tn";
                    let params = {
                        id: qh.id
                    };
