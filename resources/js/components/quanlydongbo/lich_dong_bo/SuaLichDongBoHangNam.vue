                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <h3 class="modal-title text-uppercase">
                                CHỈNh sửa CẤU HÌNH ĐỒNG BỘ DỮ LIỆU hàng năm</h3>
                        </div>
                        <div class="col-md-4">
                            <div class="row">
    ...
    export default {
        ...
        watch: {
            ...
            item: function (newVal, oldVal) {
                console.log("Chỉnh sửa: 1234567890");
                this.idDuLieu = newVal.id;
                console.log("chỉnh sửa ahihi" + this.idDuLieu);
                this.getDuLieuPhatSinh();

            },
            namHoc:function(newVal){
                console.log("năm học thay đổi");
                this.namHoc = newVal;
            }
        },
        data() {
        ...
        mounted: function () {
            ...
            console.log("Mounted Chỉnh sửa lịch đồng bộ hàng năm:");
            this.getDuLieuPhatSinh();
        },
        ...
        methods: {
            ...
            getDuLieuPhatSinh() {
                console.log("lấy dữ liệu phát sinh" + JSON.stringify(this.item.id));
                let params = {
                    "id": this.item.id
                };
            ...
            onBtnAddClick() {
                ...
                confirmDialog("Bạn muốn chỉnh sửa lịch đồng bộ này chứ ?", "Sửa", () => {
                    ...
                    let url = "chinh-sua-lich-dong-bo-tn";
