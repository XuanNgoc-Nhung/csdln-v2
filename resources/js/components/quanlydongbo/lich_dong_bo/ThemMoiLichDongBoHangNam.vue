                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <date-picker :config="configDatePicker" placeholder="Từ ngày" ref="start_dau_nam"
                                         v-model="start_dau_nam" @dp-change="ChonNgayDauNamBatDau"></date-picker>
                            ...
                            <div class="row row_tp" v-for="(k, index) in list_du_lieu_phat_sinh" :key="k.id">
                                ...
                                <div class="col-sm-3">
                                    <date-picker :config="configDatePicker" placeholder="Từ ngày" ref="ngayBatDau"
                                                 v-model="k.ngayBatDau" @dp-change="BatDauPhatSinh(k)"></date-picker>
                    ...
                    <div class="row row_tp">
                        ...
                        <div class="col-lg-4">
                            ...
                            <date-picker :config="configDatePicker" placeholder="Từ ngày" ref="start_cuoi_nam"
                                         v-model="start_cuoi_nam" @dp-change="ChonNgayCuoiNamBatDau"></date-picker>
 ...
 Vue.use(VueAlertify, {
    ...
    export default {
        ...
        mounted: function () {
            ...
            console.log("Mounted Thêm mới lịch đồng bộ hàng năm:");
        },
        ...
        methods: {
            ...
            BatDauPhatSinh(item) {
                item.ngayKetThuc = moment(item.ngayBatDau, 'DD/MM/YYYY').add(6, 'days').format('DD/MM/YYYY');
            },
            ...
            ChonNgayDauNamBatDau() {
                if (this.start_dau_nam != null) {
                    ...
                    let endDauNam = moment(this.start_dau_nam, 'DD/MM/YYYY').add(6, 'days').format('DD/MM/YYYY');
            ...
            ChonNgayCuoiNamBatDau() {
                if (this.start_cuoi_nam != null) {
                    ...
                    let endCuoiNam = moment(this.start_cuoi_nam, 'DD/MM/YYYY').add(6, 'days').format('DD/MM/YYYY');
