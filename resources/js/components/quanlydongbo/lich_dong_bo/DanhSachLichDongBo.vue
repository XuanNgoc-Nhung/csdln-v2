        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>DANH SÁCH CẤU HÌNH ĐẨY DỮ LIỆU</label>
                            ...
                            <div class="table-responsive row_tp">
                                        ...
                                        <tr v-for="(nd,i) in list_dongbo">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" title="Khóa/Mở khóa" v-on:click.prevent="lockSync(nd.id)">
                                                    ...
                                                    <i v-else="v-else" class="fas fa-unlock-alt"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <Page :total_rows="total_rows" @pageChange="onPageChange"></Page>
                                    <ThemMoiLichDongBo
                                        ...
                                        @success="onCreatedData"></ThemMoiLichDongBo>
                                <ChinhSuaLichDongBo
                                    :show="show_update"
                                    :item="dataEdit"
...
<script>
    ...
    import ThemMoiLichDongBo from "./ThemMoiLichDongBo";
    import ChinhSuaLichDongBo from "./SuaLichDongBo";
    import ThongTinLichDongBo from "./ThongTinLichDongBo";
        ...
        methods: {
            ...
            getData() {
                ...
                rest_api.get("/csdlgd-admin/yeuCauDongBo/list", params, (data) => {
                    console.log("trar veef:" + JSON.stringify(data.data))
                    if (data.data.rc==0){
