    ...
    <div>
        ...
        <div class="row page-header">
            <div class="col-sm-6 text-uppercase">
                <a href="#" style="font-size:10pt">TRANG CHỦ </a><span><span class="kytu"> &raquo;</span> KẾT CHUYỂN DỮ
                    LIỆU LÊN BỘ <span class="kytu"> &raquo;</span> KẾT CHUYỂN DỮ LIỆU IOC</span>
            </div>
        </div>
        <!-- end header -->
        <!-- start filter -->
        <div class="row">
            ...
            <div class="col-md-4 timkiem">
                ...
                <eselect style="width:100%" :disabled="thongtin.role>3" multiple collapseTags v-model="ds_don_vi"
                         :placeholder="'Chọn'" filterable @change="ChonDonVi" :data="list_don_vi"
            ...
            <div class="col-md-2 timkiem">
                ...
                <select v-model="hocKy" @change="ChonHocKy" class="form-control">
                    <option v-for="(hk,i) in list_hoc_ky" :value='hk.id' :key="i">
                        {{ hk.name }}
                    </option>
                </select>
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="input-group input-daterange">
                    ...
                    <!-- <date-picker :config="configDatePicker" placeholder="Ngày bắt đầu" @dp-change="ChonNgayBatDau"
                                 v-model="tuNgay"></date-picker> -->
                    <div class="input-group-addon">đến</div>
                    <!-- <date-picker :config="configDatePicker" placeholder="Ngày kết thúc" v-model="denNgay"></date-picker> -->
            ...
            <div class="col-md-4">
                <label>Mã trường bổ sung
                    <el-tooltip effect="dark"
                                ...
                                placement="top">
                        <span><b><i style="color:blue" class="el-icon-info"></i></b></span>
                    </el-tooltip>
                </label>

                <textarea class="form-control" @change="maTruongBoSung = maTruongBoSung.trim()" v-model="maTruongBoSung"
                          style="height:30px" rows="3"></textarea>
            </div>
            <div class="col-md-2">
                ...
                <eselect style="width:100%;" multiple collapseTags v-model="lstCapHoc" :placeholder="'Chọn'" filterable
                         :data="list_cap_hoc" :fields="['name','id']" />
            </div>
            <!-- Hết từ ngày -->
            <!-- Tới ngày -->
            <!-- Hết tới ngày -->
            <!-- loại đồng bộ -->
            <div v-if="loaiDanhSach==2" class="col-md-3 timkiem">
                ...
                <multiselect v-model="danhSachLoaiDongBo" :options="ds_loai_dong_bo_ket_chuyen_du_lieu"
                             ...
                             deselectLabel="Đã chọn" selectLabel="Chưa chọn" selectedLabel="Đã chọn" :preselect-first="true"
        ...
        <div class="row text-center">
            ...
            <!-- <button type="success" @click.prevent="getComBoData()">Tìm kiếm trường chưa đẩy
            </button> -->
        </div>
        <hr />
        <!-- end button -->
                ...
                <div class="panel panel-default" style="border-top:none; margin-top:0">
                    <div class="panel-body" style="padding-top:5px;">
                        ...
                        <div class="row pxn-bao-header">
                            ...
                            <div class="col-md-6">
                                <p><b>Ghi chú: </b> NT: Nhà trẻ; MG: Mẫu giáo; TH: Tiểu học; THCS: Trung học Cở sở; THPT: Trung học phổ thông.</p>
                                <!-- <b> Chú thích:</b> -->
                                <!-- <div style="width:20px; height:15px; background:#d6ffd8;display:inline-block"></div>:Đã duyệt -->
                            </div>
                            <div class="col-md-6 text-right">
                                <el-button type="success dpull-right" v-if="hienHanhDong&&thongtin.role==125"
                                ...
                                <el-tooltip content="Đẩy dữ liệu lên ioc" placement="top">
                                    <el-button v-if="hienthibutton&&hienHanhDong&&CacTruongDay.length" type="primary"
                                               size="mini" v-on:click.prevent="dayLaiDuLieu2">
                                        Đẩy lên IOC
                                    </el-button>
                                </el-tooltip>
                                <el-tooltip content="Xuất dữ liệu " placement="top">
                                    <el-button type="success" size="mini" v-if="hienHanhDong"
...
<!--                                    <th rowspan="2" class="fixed-column fixed-col2">-->
<!--                                        <p>Thao tác</p>-->
<!--                                    </th>-->
                                    <th rowspan="2">
                                        <p>Trường học</p>
                                    ...
                                    <th v-if="hienHanhDong&&(hienthibutton||truong_duoc_phep||true)" rowspan="2">
                                        <label class="typo__label">Chọn loại dữ liệu</label>
                                        <div style="width:100%">
                                            <!-- <el-select clearable v-model="danhSachChonDongBo" multiple filterable
                                                collapse-tags placeholder="Chọn loại dữ liệu"
                                                no-data-text="Không có dữ liệu"
                                                no-match-text="Không có dữ liệu phù hợp">
                                                <el-option v-for="item in list_dong_bo_du_lieu" :key="item.key"
...
<!--                                                <i class="el-icon-notebook-2" @click.prevent="XemLichSu(yc)"></i>-->
<!--                                                &lt;!&ndash; </el-button> &ndash;&gt;-->
<!--                                            </el-tooltip>-->
...
<!--                                                <i @click.prevent="DuyetLenCapTren(yc)" class="el-icon-check"></i>-->
<!--                                            </el-tooltip>-->
<!--                                            <el-tooltip-->
...
<!--                                            </el-tooltip>-->
<!--                                            <el-tooltip v-if="thongtin.role==4" content="Từ chối" placement="top">-->
<!--                                                &lt;!&ndash; <el-button type="danger"-->
<!--                                                    size="mini"> &ndash;&gt;-->
<!--                                                <i @click.prevent="tuChoiPhong(yc)" class="el-icon-close"></i>-->
<!--                                                &lt;!&ndash; </el-button> &ndash;&gt;-->
<!--                                            </el-tooltip>-->
<!--                                            <el-tooltip v-if="thongtin.role==2||thongtin.role==3" content="Từ chối"-->
<!--                                                        placement="top">-->
...
<!--                                    </td>-->
                                    ...
                                    <td class="text-center">
                                        <a href="#" title="Xem chi tiết" @click.prevent="ChuyenHuongHocSinh(yc)">
                                    ...
                                    <td v-if="hienHanhDong&&(hienthibutton||truong_duoc_phep||true)">
                                        <div>
                                            <!-- Thay đổi -->
                                            <!-- <el-select clearable v-model="yc.key" multiple filterable collapse-tags
                                             ...
                                             -->
                                            <eselect style="width:100%" multiple collapseTags
                                                     v-model="yc.key" @change="chonDuLieuDay"
                                                     :placeholder="'Chọn'" filterable :data="yc.thongTinBuocDays"
                                                     :fields="['name','key']" />
                                            <!-- Hết thay đổi -->
                                        </div>
                                    </td>
                                    <!-- <td> <p>{{getTrangThai(yc.status)}}</p> </!-->
        ...
        <DayLaiDuLieu :show="show_daylai" :noi-nop="1" :cap_hoc_day="lstCapHoc" :item="CacTruongDay" :namhoc="namHoc"
                ...
                <ul>
                    ...
                    <li style="list-style-type: none;">
                        ...
                        <span>
                            ...
                            <b>MG</b>:<i>Mẫu giáo</i>;
                            <b>TH</b>:<i>Tiểu học</i>;
                            <b>THCS</b>:<i>Trung học cở sở</i>;
                            <b>THPT</b>:<i>Trung học phổ thông</i>;
                        </span>
                    </li>
                </ul>
            </div>
    ...
    methods: {
        ...
        getData() {
            ...
            let params = {
                ...
                namHoc: this.namHoc,
                hocKy: this.hocKy,
                startDate: this.tuNgay,
                endDate: this.denNgay,
                // loaiDongBo: this.ds_loai_dong_bo, status: this.ds_trang_thai,
                start: this.start,
                showOnlyIncompleteSchool: this.truongChuaHoanThanh,
                limit: this.limit
            ...
            rest_api.post("/csdlgd-admin/yeuCauDuLieuTruong/search2", params, (data) => {
                ...
                console.log(JSON.stringify(this.list_truong_hoc_chua_day));
