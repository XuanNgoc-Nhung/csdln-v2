<template>
    <div>
        <div class="row page-header">
            <div class="col-sm-6">
                <h3 class=" text-uppercase">CẤU HÌNH LỊCH ĐỒNG BỘ Hàng năm</h3>
            </div>
...
<script>
    ...
    import DanhSachLichDongBo from './lich_dong_bo/DanhSachLichDongBoHangNam';
    import ThemLichDongBo from './lich_dong_bo/ThemMoiLichDongBoHangNam';
    import SuaLichDongBo from './lich_dong_bo/SuaLichDongBoHangNam';
    ...
    export default {
        ...
        methods: {
            ...
            LayDanhSachYeuCauDongBo() {
                ...
                let uri = "/csdlgd-admin/yeuCauDongBoTn/list";
