<template>
    <div>
        <div class="bieudo" id="tongquancanbogiaovien"></div>
    </div>
</template>
<style>
</style>
    ...
    export default {
        ...
        watch: {
            dulieu: function (newVal) {
                if (newVal) {
                    ...
                    var bieuDo = new ApexCharts(document.querySelector("#tongquancanbogiaovien"), this
                        .bieuTongQuanNhaTruong);
                    bieuDo.render();
        ...
        methods: {
            ...
            ganDuLieuBieuDoTongQuanNhaTruong() {
                var chartDuong = new ApexCharts(document.querySelector("#tongquancanbogiaovien"), this
                    .bieuTongQuanNhaTruong);
                chartDuong.render();
            },
        },
