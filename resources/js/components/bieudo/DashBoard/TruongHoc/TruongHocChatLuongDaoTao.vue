<template>
    <div>
        <div class="bieudo" id="chatluongdaotaotruonghoc"></div>
    </div>
</template>
<style>
</style>
    ...
    export default {
        ...
        methods: {
            ...
            bindData(e) {
                ...
                console.log("stackedType");
                let categories = ['C.Lượng tối thiểu', 'Chuẩn mức 1', 'Chuẩn mức 2'];
                let element = document.querySelector("#chatluongdaotaotruonghoc");
