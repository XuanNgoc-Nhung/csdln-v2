<template>
    <div>
        <div class="bieudo" id="phanloaicanbotheodotuoi"></div>
    </div>
</template>
<style>
</style>
    ...
    export default {
        ...
        methods: {
            ...
            bindData(e) {
                ...
                let series = e;
                let categories = ['<20', '20-29', '30-39', '40-49', '50-54', '55-59', '≥60'];
                let element = document.querySelector("#phanloaicanbotheodotuoi");
            ...
            generateChart(series, categories, element, hienthitungo) {
                ...
                const options = {
                    ...
                    //     '#60BFFF', '#90ED7D'
                    // ],
                    colors : ["#F00", "#F9B846","#60BFFF", "#32C5A7","#B3B96A", "#FF6767",'#00a65a', '#FFA200',
                    '#60BFFF', '#1ab394'],
                    chart: {
                        type: "bar",
                        width: '100%',
