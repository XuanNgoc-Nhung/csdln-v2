<template>
    <div>
        <div class="bieudo" id="phanloaicanbotheotrangthai"></div>
    </div>
</template>
<style>
</style>
    ...
    export default {
        ...
        methods: {
            ...
            bindData(e) {
                ...
                let series = e;
                let categories = ['Đang làm việc', 'Chuyển đến', 'Chuyển đi', 'Khác'];
                let element = document.querySelector("#phanloaicanbotheotrangthai");
