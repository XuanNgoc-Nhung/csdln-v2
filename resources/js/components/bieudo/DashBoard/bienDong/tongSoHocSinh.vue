...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            bindData(e) {
                let series = e;
                let categories = this.getConsecutiveNumbersBefore(this.namHoc, 5)
                // let categories = ['Giỏi', 'Khá', 'Trung bình', 'Yếu', 'Kém', 'Khác'];
                let hienthitungo = this.hienThiGiaTriMoiO;
                // let element = document.querySelector("#danhgiahocsinhcanam");
            ...
            generateChart(series, categories, element, hienthitungo) {
                ...
                const options = {
                    series,
                    // colors: ['#60BFFF', '#90ED7D', '#014839', '#FB4444'],
