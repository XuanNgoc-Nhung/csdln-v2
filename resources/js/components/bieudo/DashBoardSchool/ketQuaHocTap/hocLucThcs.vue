        ...
        <el-col :md="12" :lg="8">
            <div class="dts-moibieudo grid-content bg-purple-light">
                <div class="dts-card-header">
                    <span class="dts-card-title">Học sinh thcs {{name}}</span>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log("Mounted thông tin trong biểu đồ học lực thcs:")
        ...
        watch: {
            item: function (newVal) {
                if (newVal) {
                    console.log("Thay đổi thông tin trong biểu đồ học lực thcs:")
                    console.log(newVal)
                    this.BindData();
                }
            },
            ...
            bindData(e) {
                ...
                for (let j = 0; j < series.length; j++) {
                    for (let i = 0; i < this.item.length; i++) {
                        if(series[j].id==this.item[i].name){
                            series[j].data=this.item[i].data;
                        }
                    }
                }
                let categories = ['Khối 6', 'Khối 7', 'Khối 8', 'Khối 9'];
