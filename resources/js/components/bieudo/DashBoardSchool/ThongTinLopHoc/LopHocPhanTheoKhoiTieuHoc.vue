        ...
        <el-col :md="12" :lg="8">
            <div class="dts-moibieudo grid-content bg-purple-light">
                <div class="dts-card-header">
                    <span class="dts-card-title">lớp học tiểu học {{name}}</span>
                </div>
    ...
    export default {
        ...
        methods: {
            bindData() {
                ...
                let categories = ['Khối 1', 'Khối 2', 'Khối 3', 'Khối 4', 'Khối 5'];
                // let element = document.querySelector("#thongkehocsinhtheokhoi");
