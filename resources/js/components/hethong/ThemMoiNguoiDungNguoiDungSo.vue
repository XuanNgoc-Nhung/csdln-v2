<template>
    ...
    <div id="modal_create_userso" ref="modal_create_userso" class="modal fade">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            $("#modal_create_userso").modal();
            $(this.$refs.modal_create_userso).on("hidden.bs.modal", this.close);
            this.getRole();
        ...
        methods: {
            ...
            TaoNguoiDung() {
                ...
                console.log("vai tròi:" + this.vaiTro)
