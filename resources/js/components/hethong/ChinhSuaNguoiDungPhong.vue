<template>
    <div id="modal_update_userphong" ref="modal_update_userphong" class="modal fade">
                    ...
                    <div class="row">
                        ...
                        <div v-if="vaiTro==4||vaiTro==5||vaiTro==40" class="pxn-col col-md-4">
                            ...
                            <multiselect v-model="danhSachDonViPhong" :options="list_don_vi_phong"
                                :close-on-select="true" :preserve-search="false" :disabled="isDisabledPhong"
                                @close="dongChonSo" deselectLabel="Đã chọn" selectLabel="Chưa chọn"
                                selectedLabel="Đã chọn" :custom-label="setNameDonVi" placeholder="Chọn đơn vị"
                                label="maDonVi" track-by="tenDonVi"></multiselect>
                        </div>
                        <!-- Trường -->
                ...
                <div class="modal-footer clearfix">
                    <div class="row">
                        ...
                        <div class="pxn-col col-md-6">
                            ...
                            <button type="submit" @click.prevent="ChinhSuaNguoiDung()" class="btn btn-primary">Chính sửa
                            </button>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            $("#modal_update_userphong").modal();
            this.getRole();
            $(this.$refs.modal_update_userphong).on("hidden.bs.modal", this.close);
