<template>
    <div id="modal_update_adminso" ref="modal_update_adminso" class="modal fade">
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            this.getRole();
            $("#modal_update_adminso").modal();
            $(this.$refs.modal_update_adminso).on("hidden.bs.modal", this.close);
