<template>
    ...
    <div id="modal_create_email" ref="modal_create_email" class="modal fade">
        <div class="modal-dialog" style="width: 70%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h3 class="modal-title text-uppercase">Thêm Email Mới</h3>
                </div>
    ...
    export default {
        ...
        watch: {
            ...
            item: function (newVal, oldVal) {
                console.log("mã sở là : " + JSON.stringify(newVal));
                this.ma_so = newVal;
                console.log("aaa" + this.ma_so);
                this.getDonVi();
            }
        },
        data() {
        ...
        mounted: function () {
            console.log("mounted !!!!!");
            $(this.$refs.modal_create_email).on("hidden.bs.modal", this.close);
        ...
        methods: {
            createEmail() {
                ...
                utils.confirmDialog("Xác nhận thêm Email", "Thêm", () => {
                    let params = {
                    ...
                    console.log("thêm email với: " + params);
                    rest_api.post("/internal-api/cauHinhEmail/create", params, (data) => {
