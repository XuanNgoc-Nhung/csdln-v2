    ...
    export default {
        ...
        methods: {
            ...
            checkThemMoi() {
                ...
                if (!this.emailNguoiDung && this.thongtin.ma_so!=64) {
                    this.duoc_them_moi = false;
                }
                if (!this.sdtNguoiDung && this.thongtin.ma_so!=64) {
                    this.duoc_them_moi = false;
                }
                if (!this.vaiTro) {
                    this.duoc_them_moi = false;
            ...
            TaoNguoiDung() {
                ...
                console.log("thông tin thêm mới:" + JSON.stringify(params));
                // xác nhận thêm mới
            ...
            ChonVaiTro() {
                ...
                this.danhSachDonViPhong = "";
                this.danhSachDonViTruong = "";
                console.log("chọn vai trò" + this.vaiTro);
            ...
            getDonViSo() {
                ...
                if (this.thongtin.role == 2 || this.thongtin.role == 20) {
