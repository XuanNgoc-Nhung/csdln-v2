        ...
        <el-dialog width="70%" top="5vh" :title="text_header" custom-class="showThongTinLoiImportSSO"
            ...
            <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Mã học sinh <span class="red">*</span></label>
                    <el-input clearable ref="maHocSinh" placeholder="Nhập..." v-model="dataEdit.maHocSinh"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Tên học sinh</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.hoTen"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    ...
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.soDthoaiDdong"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Lớp học</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.maLopHoc"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Khối học</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.khoiHoc"></el-input>
                </el-col>
    ...
    export default {
        ...
        data() {
            return {
                ...
                show_update: false,
                text_header: 'Chỉnh sửa thông tin học sinh',
        ...
        methods: {
            ...
            upDateDuLieu() {
                ...
                let params = {
                    ...
                    "hoTen": this.dataEdit.hoTen,
                    "khoiHoc": this.dataEdit.khoiHoc,
                    "lopHoc": this.dataEdit.maLopHoc,
                    "maHocSinh": this.dataEdit.maHocSinh,
                    "maTruongHoc": this.dataEdit.maTruongHoc,
                    "namHoc": this.dataEdit.namHoc,
                    "ngaySinh": this.dataEdit.ngaySinh,
                    "soDienThoai": this.dataEdit.soDthoaiDdong,
                };
                this.loading.text = 'Vui lòng đợi...';
                this.loading.status = true;
                rest_api.post("/csdlgd-admin/sso/editHocSinh", params, (response) => {
            ...
            confirmUpdate() {
                ...
                if (!this.dataEdit.maHocSinh || this.dataEdit.maHocSinh == '') {
                    this.thongBao('error', 'Có lỗi trong quá trình thao tác. Vui lòng thử lại');
                    return;
                }
                if (!this.dataEdit.maHocSinh || this.dataEdit.maHocSinh == '') {
                    this.thongBao('error', 'Thiếu thông tin mã học sinh');
                    this.$refs.maHocSinh.focus();
                    return;
                }
                this.upDateDuLieu();
