<template>
    <div v-loading.fullscreen.lock="loading.status" :element-loading-text="loading.text"
        ...
        <el-dialog width="70%" top="5vh" :title="text_header" custom-class="showThongTinLoiImportSSO"
            ...
            <el-row :gutter="20">
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    ...
                    <el-input clearable ref="maCanBo" placeholder="Nhập..." v-model="dataEdit.maGiaoVien"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Tên giáo viên</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.tenGiaoVien"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Giới tính</label>
                    <eselect collapseTags v-model="dataEdit.gioiTinh" :placeholder="'Chọn'" filterable
                        :data="list_gioi_tinh" :fields="['name','value']" />
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Ngày sinh</label>
                    <date-picker :append-to-body="false" v-model="dataEdit.ngaySinh" placeholder="Chọn"
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Địa chỉ</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.dchiThtru"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Tỉnh thành</label>
                    <eselect collapseTags v-model="dataEdit.maTthanhThtru" @change="chonTinhThanh" :placeholder="'Chọn'"
                        filterable :data="danh_sach_tinh_thanh" :fields="['name','value']" />
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Quận huyện</label>
                    <eselect collapseTags v-model="dataEdit.maQhuyenThtru" :placeholder="'Chọn'" filterable
                        :data="danh_sach_quan_huyen" :fields="['name','value']" />
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Mã môn học</label>
                    <el-input clearable placeholder="Nhập..." v-model="dataEdit.maMonHoc"></el-input>
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    <label>Chủ nhiệm lớp</label>
                    <eselect collapseTags v-model="dataEdit.chuNhiemLop" :placeholder="'Chọn'" filterable
                ...
                <el-col :xs="24" :sm="24" :md="16" :lg="12">
                    ...
                    <eselect collapseTags v-model="dataEdit.maTruongHoc" :placeholder="'Chọn'" filterable
                        :data="danh_sach_truong_hoc" :fields="['name','value']" />
                </el-col>
            </el-row>
    ...
    export default {
        ...
        data() {
            return {
                ...
                show_update: false,
                text_header: 'Chỉnh sửa thông tin cán bộ giáo viên',
        ...
        methods: {
            chonTinhThanh() {
                ...
                this.dataEdit.maQhuyenThtru = '';
                if (this.dataEdit.maTthanhThtru) {
            ...
            upDateDuLieu() {
                ...
                let params = {
                    ...
                    "can_bo_theo_nam_id": this.dataEdit.canBoTheoNamId,
                    "diaChi": this.dataEdit.dchiThtru,
                    "email": this.dataEdit.email,
                    "gioiTinh": this.dataEdit.gioiTinh,
                    "hoTen": this.dataEdit.tenGiaoVien,
                    "maGiaoVien": this.dataEdit.maGiaoVien,
                    "maMonDay": this.dataEdit.maMonHoc,
                    "maQuanHuyen": this.dataEdit.maQhuyenThtru,
                    "maTinhThanh": this.dataEdit.maTthanhThtru,
                    ...
                    "isChuNhiemLop": this.dataEdit.chuNhiemLop,

                };
                if (this.dataEdit.chuNhiemLop === '0' || this.dataEdit.chuNhiemLop === '1') {
                    params.isChuNhiemLop = parseInt(this.dataEdit.chuNhiemLop);
                } else {
                    delete params.isChuNhiemLop;
                }
            ...
            confirmUpdate() {
                ...
                if (!this.dataEdit.canBoTheoNamId || this.dataEdit.canBoTheoNamId == '') {
                    this.thongBao('error', 'Có lỗi trong quá trình thao tác. Vui lòng thử lại');
                    return;
                }
                if (!this.dataEdit.maGiaoVien || this.dataEdit.maGiaoVien == '') {
