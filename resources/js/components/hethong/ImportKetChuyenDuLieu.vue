        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập thông tin</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="download_link" target="_blank">Tại đây</a></label><br><span><b>Ghi chú:</b><i><span>Vui lòng lựa chọn tệp dạng *.xlsx</span></i></span>
                        </div>
                    </div>
                </div>
