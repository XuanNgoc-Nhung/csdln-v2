<template>
    ...
    <div
        id="modal_create_userphong"
        ref="modal_create_userphong"
        class="modal fade">
        ...
        <div class="modal-dialog" style="width: 90%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Thêm mới người dùng</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="pxn-col col-md-2">
                            ...
                            <select @change="ChonVaiTro()" v-model="roleIdVaiTro" class="form-control">
                        ...
                        <!-- sở -->
                        <div
                            v-if="vaiTro==3||vaiTro==4||vaiTro==5||vaiTro==40||vaiTro==20"
                            class="pxn-col col-md-4">
                            <label class="typo__label">Chọn sở phụ trách <span class="red">*</span></label>
                            <multiselect
                                v-model="danhSachDonViSo"
                                :options="list_don_vi_so"
                        ...
                        <div v-if="vaiTro==4||vaiTro==5||vaiTro==40" class="pxn-col col-md-4">
                            ...
                            <multiselect
                                v-model="danhSachDonViPhong"
                                :options="list_don_vi_phong"
                                :close-on-select="true"
                                :disabled="isDisabledPhong"
                                :preserve-search="false"
                                deselectLabel="Đã chọn"
                                selectLabel="Chưa chọn"
                                selectedLabel="Đã chọn"
    ...
    export default {
        ...
        data() {
            return {
                ...
                thongtin: {},
                isDisabled: true,
                isDisabledPhong: true
            }
        },
        mounted: function () {

            this.thongtin = JSON.parse(window.userInfo);
            console.log("thông tin:" + JSON.stringify(this.thongtin));
            $("#modal_create_userphong").modal();
            $(this.$refs.modal_create_userphong).on("hidden.bs.modal", this.close);
            this.getRole();
        ...
        methods: {
            ...
            TaoNguoiDung() {
                ...
                if (this.vaiTro == 5) {for (let i=0; i<this.list_truong_hoc.length;i++){
                ...
                dialog.confirmDialog("Xác nhận thêm mới người dùng?", "Đồng ý", () => {
                    rest_api.post("/csdlgd-user/adminUser", params, (response) => {
                        console.log("thêm người dùng trả về:" + JSON.stringify(response));
            ...
            ChonVaiTro() {
                ...
                // console.log(JSON.stringify(this.list_role));
                this.vaiTro ="";
                for(let i=0; i<this.list_role.length;i++){
                    if(this.list_role[i].roleId==this.roleIdVaiTro){
                        this.vaiTro = this.list_role[i].parentRole;
                    }
                }
                this.ma_don_vi_so = "";
                this.ma_don_vi_phong = "";
                ...
                // tương đương sở
                this.getDonViSo();
                // } this.getDonViPhong(); this.getDonViTruong();
            },
            boPhanTuTrung(arr) {
            ...
            getDonViSo() {
                ...
                if (this.thongtin.role == 3 || this.thongtin.role == 40) {
                    params.maTinhThanh = this.thongtin.province
                }
                rest_api.get("/internal-api/dmDonVi/filter", params, (data) => {
                    if (data.data.code == 200) {
                        console.log("lấy sở trả về");
            ...
            getDonViPhong() {
                ...
                let params = {
                    "start": 0,
                    "limit": 500,
                    "maDonViCha": this.ma_don_vi_so,
                    "loaiDonVi": 2,
                    "ma": this.thongtin.ma_phong
                };
                console.log("param:" + JSON.stringify(params));
                rest_api.get("/internal-api/dmDonVi/filter", params, (data) => {
                    console.log("lấy phòng trả về: " + JSON.stringify(data.data));
                    if (data.data.code == 200) {
            ...
            getDonViTruong() {
                let params = {
                    maPhong: this.thongtin.ma_phong
                };
                console.log("lấy trường");
                console.log("thông tin:" + JSON.stringify(this.thongtin));
