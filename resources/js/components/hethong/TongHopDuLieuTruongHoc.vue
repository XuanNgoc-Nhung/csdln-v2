        ...
        methods: {
            ...
            TongHopDuLieuNhaTruong() {
                ...
                rest_api.post("/csdlgd-report-fetch/refetch/dasboartBc", params, (data) => {
                    ...
                    console.log(data.data);
                    if (data.data.rc == 0) {
                        this.thongBao('success','Hệ thống đang tiến hành tổng hợp lại các báo cáo và hồ sơ tra cứu. Thông tin mới nhất từ QLNT nộp lên sẽ hiển thị trong vài phút tới.')
