<template>
    <div>
        <Breadcrumb :menu="'Kết chuyển dữ liệu'" :desc="'Mật khẩu kết chuyển lên IOC'"/>
            ...
            <el-row :gutter="24">
                ...
                <el-col :span="24">
                    <div class="centerBetweenFlex">
                        <label class="table-name">Danh sách mật khẩu kết chuyển lên IOC</label>
                        <div class="text-right">
                            <el-tooltip placement="top">
                                <div slot="content">Thêm mới mật khẩu kết chuyển</div>
                                <el-button class="bt-chinh" plain type="primary" @click.prevent="themMoiMatKhauKetChuyen"
...
<!--                    </div>-->
        ...
        <div>
            ...
            <el-dialog title="Thêm tài khoản kết chuyển lên IOC" :visible.sync="modal_them_moi" width="1000px"
