<template>
    ...
    <div id="modal_update_superadmin" ref="modal_update_superadmin" class="modal fade">
        ...
        <div class="modal-dialog" style="width: 90%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Chỉnh sửa người dùng </h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div v-if="vaiTro==2||vaiTro==3||vaiTro==4||vaiTro==5||vaiTro==40||vaiTro==20"
                            ...
                            <multiselect v-model="danhSachDonViSo" :options="list_don_vi_so" :close-on-select="true"
                                ...
                                @close="dongChonSo" selectedLabel="Đã chọn" :custom-label="setNameDonVi"
                                placeholder="Chọn đơn vị" label="maDonVi" track-by="tenDonVi"></multiselect>
                        </div>
                        <!-- Phòng -->
...
<script>
    ...
    export default {
        ...
        mounted: function () {
            ...
            $("#modal_update_superadmin").modal();
            $(this.$refs.modal_update_superadmin).on("hidden.bs.modal", this.close);
