                ...
                <div class="modal-body" style="width: 100%;margin: 0 auto;">
                    ...
                    <!-- <div style="height: 65vh;overflow: scroll;"> -->
                        <div class="row rct" style="margin-top:10px;display:flex">
                            ...
                            <div class="col-md-4">
                                <label class="typo__label">Chọn trường học  <span v-if="truong" style="color:#DC0101"> *</span></label>
                                <input type="text" disabled class="form-control" :value="thongtincauhinh.tenTruongHoc">
                            </div>
                        </div>
                        <div class="row" style="padding-top:20px;">
                            <div class="col-md-12">
                                <span style="margin:0 10px 0 0"><input :disabled="thongtincauhinh.loaiDonVi!=2" style="margin-right:10px" v-model="phongDuocNopLenBo" type="checkbox">Phòng được đẩy lên IOC</span>
                                <span style="margin:0 10px"><input  :disabled="thongtincauhinh.loaiDonVi!=3" style="margin-right:10px" v-model="truongDuocNopLenBo" type="checkbox">Trường được đẩy lên IOC</span>
                            </div>
                        </div>
                    </div>
                </div>
