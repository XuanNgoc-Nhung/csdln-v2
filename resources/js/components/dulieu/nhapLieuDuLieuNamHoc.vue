        ...
        <div class="card-bieu-do" style="padding:12px">
            ...
            <el-row :gutter="24">
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
                    ...
                    <eselect style="width:100%" :disabled="thongtin.role>3" collapseTags v-model="loaiDuLieu"  :placeholder="'Chọn'" filterable :data="loai_du_lieu"
                             :fields="['name','value']" />
                </el-col>
                <el-col :xs="24" :sm="12" :md="8" :lg="6">
        ...
        data() {
            return {
                ...
                loai_du_lieu:[
                    ...
                    {name:'Dữ liệu lớp học',value:2},
                    {name:'Dữ liệu giáo viên',value:3},
                    {name:'Dữ liệu kết quả học tập',value:4},
                    {name:'Dữ liệu nhà trường',value:5},
                ],
