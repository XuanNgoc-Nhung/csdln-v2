<template>
    ...
    <div id="modal_them_tieu_chuan" ref="modal_them_tieu_chuan" class="modal fade">

        <div class="modal-dialog" style="width:50%">

            <div class="modal-content">
                <form @submit.prevent="themChuanChieuCaoCanNangSubmit">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true" v-on:click="close()">
                            &times;
                        </button>
                        <h4 class="modal-title text-uppercase">Thêm tiêu chuẩn chiều cao, cân nặng</h4>
                    </div>
                    <div class="modal-body clearfix">
                        <div style="padding-top: 10px">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ required: true, max:30, regex: /^[a-zA-Z0-9_]*$/}" name="ma_tieuchuan" type="text"
                                           v-model="ma_tieuchuan"
                                           placeholder="Nhập..."
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('ma_tieuchuan')">{{ errors.first('ma_tieuchuan') }}</span></span>
                                </div>
                                <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('loai_tieuchuan')">{{ errors.first('loai_tieuchuan') }}</span></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ required: true, regex: /^[0-9]*$/}" name="thang" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('thang')">{{ errors.first('thang') }}</span></span>
                                </div>
                                <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ required: true, regex: /^[0-9]*$/}" name="standard0" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standard0')">{{ errors.first('standard0') }}</span></span>
                                </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standard1" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standard1')">{{ errors.first('standard1') }}</span></span>
                                </div>
                                <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standardSub1" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standardSub1')">{{ errors.first('standardSub1') }}</span></span>
                                </div>
                            </div>
                        </div>
                        <div style="padding-top: 10px">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standard2" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standard2')">{{ errors.first('standard2') }}</span></span>
                                </div>
                                <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standardSub2" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standardSub2')">{{ errors.first('standardSub2') }}</span></span>
                                </div>
                            </div>
                        </div>
                        <div style="padding-top: 10px">
                            <div class="form-group clearfix">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standard3" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standard3')">{{ errors.first('standard3') }}</span></span>
                                </div>
                                <div class="col-sm-2 text-right">
                                ...
                                <div class="col-sm-4">
                                    <input v-validate="{ regex: /^[0-9]*$/}" name="standardSub3" type="text"
                                           ...
                                           class="form-control control-inline"
                                           style="min-width: 50px;"/>
                                    <span v-if="show_msg"><span class="text-danger" v-show="errors.has('standardSub3')">{{ errors.first('standardSub3') }}</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    export default {
        ...
        watch: {
            show: function (newVal, oldVal) {
                ...
                if (newVal) {
                    this.reset();
                    $("#modal_them_tieu_chuan").modal();
                } else {
                    $("#modal_them_tieu_chuan").modal('hide');
                }
            }
        },
        ...
        mounted: function () {
            console.log("mounted !!!!!");
            $(this.$refs.modal_them_tieu_chuan).on("hidden.bs.modal", this.close);
            this.customMessage();
        },
        ...
        methods: {
            customMessage(){
                const dict = {
                    custom: {
                        ma_tieuchuan: {
                            required: () => 'Mã tiêu chuẩn không thể trống',
                            max: () => 'Mã tiêu chuẩn không vượt quá 30 ký tự',
                            regex: () => 'Mã tiêu chuẩn chỉ chứa chữ cái, chữ số, dấu gạch dưới'
                        },
                        loai_tieuchuan: {
            ...
            themChuanChieuCaoCanNangSubmit(){
                this.show_msg = true;
                this.$validator.validateAll().then(result => {
                    if (result){
                        this.createTieuChuan();
                    }
                });
            },
            createTieuChuan() {
                ...
                utils.confirmDialog("Xác nhận thêm tiêu chuẩn", "Thêm", () => {
                    ...
                    api.post(uri, params, (response) => {
                        ...
                        if (response.data.code === 200) {
                            utils.showDialog("Thông báo", "Thêm tiêu chuẩn thành công", null, () => {
