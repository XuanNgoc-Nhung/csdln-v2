<template>
    ...
    <div id="modal_chinhsua_doitac" ref="modal_chinhsua_doitac" class="modal fade">
        ...
        <div class="modal-dialog" style="width:70%">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">chỉnh sửa đối tác</h4>
                </div>
                    ...
                    <div style="padding-top: 10px">
                        <div class="form-group clearfix">
                            ...
                            <div class="col-sm-2 text-right" style="text-align:right">
                                <label>
                                    <input type="checkbox" v-model="updatePass" style="line-height: 34px;"/>Update mật khẩu</label>
                            </div>
                            <div class="col-sm-4">
                                <input
                                    v-if="updatePass"
                ...
                <div class="modal-footer clearfix">
                    ...
                    <button type="button" class="btn btn-primary" v-on:click="suaDoiTac">Sửa
                    </button>
                </div>
            </div>
    ...
    export default {
        ...
        watch: {
            show: function (newVal, oldVal) {
                ...
                if (newVal) {
                    this.reset();
                    $("#modal_chinhsua_doitac").modal();
                } else {
                    $("#modal_chinhsua_doitac").modal('hide');
                }
            },
            item: function (newVal) {
                console.log("sửa"+ JSON.stringify(newVal));
                this.ma_doi_tac=newVal.maDoiTac;
                this.ten_doi_tac=newVal.tenDoiTac;
                this.ten_dang_nhap=newVal.tenDangNhap;
                this.list_ip=newVal.whiteListIp;
                this.getService();
        ...
        mounted: function () {
            console.log("mounted !!!!!");
            $(this.$refs.modal_chinhsua_doitac).on("hidden.bs.modal", this.close);
        },

        methods: {

            suaDoiTac() {
                utils.confirmDialog("Xác nhận chỉnh sửa đối tác", "Sửa", () => {
                    this.maService=[];
                    const uri = "/api_chinh_sua_doi_tac";
