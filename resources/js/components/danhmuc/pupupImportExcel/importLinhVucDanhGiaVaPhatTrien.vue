        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập Lĩnh vực đánh giá và phát triển từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/Template_Linh_Vuc_Danh_Gia_Su_Phat_Trien.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmLinhVucDanhGiaSuPT/downloadTemplate';
            ...
            imPortFile() {
                ...
                utils.confirmDialog("Xác nhận Import file", "Đồng ý", () => {
                    const uri = "/api-import-linh-vuc-danh-gia-phat-trien";
