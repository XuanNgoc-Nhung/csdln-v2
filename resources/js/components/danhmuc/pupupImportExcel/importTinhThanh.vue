<template>
    ...
    <div id="modal_import_tinhthanh" ref="modal_import_tinhthanh" class="modal fade">
        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập Tỉnh thành từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/Template_Tinh_Thanh.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
    ...
    export default {
        ...
        watch: {
            show: function (newVal, oldVal) {
                ...
                if (newVal) {
                    $("#modal_import_tinhthanh").modal();
                } else {
                    $("#modal_import_tinhthanh").modal('hide');
                }
            }
        },
        data() {
        ...
        mounted: function () {
            console.log("mounted !!!!!");
            $(this.$refs.modal_import_tinhthanh).on("hidden.bs.modal", this.close);
            this.getDownload();
        },
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmTinhThanh/downloadTemplate';
            ...
            imPortFile() {
                ...
                utils.confirmDialog("Xác nhận Import file", "Đồng ý", () => {
                    const uri = "/api-import-tinh-thanh";
