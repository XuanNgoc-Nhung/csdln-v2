        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập quận huyện từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/Template_Quan_Huyen.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmQuanHuyen/downloadTemplate';
            ...
            imPortFile() {
                ...
                utils.confirmDialog("Xác nhận Import file", "Đồng ý", () => {
                    const uri = "/api-import-quan-huyen";
