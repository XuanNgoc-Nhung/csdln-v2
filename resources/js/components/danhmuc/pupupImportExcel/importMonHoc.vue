<template>
    <div
        v-loading.fullscreen.lock="fullscreenLoading" id="modal_import_truonghoc" ref="modal_import_truonghoc" class="modal fade">
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập Môn học từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/Template_Mon_Hoc.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmMonHoc/downloadTemplate';
