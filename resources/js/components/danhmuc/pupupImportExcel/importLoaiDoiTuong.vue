        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập loại đối tượng từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/Template_Loai_Doi_Tuong.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmLoaiDoiTuong/downloadTemplate';
            ...
            imPortFile() {
                ...
                utils.confirmDialog("Xác nhận Import file", "Đồng ý", () => {
                    const uri = "/api-import-loai-doi-tuong";
