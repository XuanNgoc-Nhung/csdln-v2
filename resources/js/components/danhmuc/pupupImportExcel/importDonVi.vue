<template>
    ...
    <div id="modal_import_truonghoc" ref="modal_import_truonghoc" class="modal fade">
        ...
        <div class="modal-dialog" style="width: 60%">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Nhập Đơn vị từ file Excel</h4>
                </div>
                <div class="modal-body clearfix">
                    ...
                    <div class="row">
                        <div class="col-lg-3"><label class="pull-right">Vui lòng chọn file mẫus</label></div>
                        <div class="col-lg-9">
                            <label><a :href="'/templateImport/dmDonVi.xlsx?t='+getTime()" target="_blank">Tại đây</a></label>
                        </div>
                    </div>
                </div>
        ...
        watch: {
            show: function (newVal, oldVal) {
                ...
                if (newVal) {
                    ...
                    $("#modal_import_truonghoc").modal('hide');
                }
            }
        },
        data() {
        ...
        methods: {
            ...
            async getDownload(){
                try{
                    ...
                    api_link += '/dmDonVi/downloadTemplate';
                    this.download_link = '/templateImport/dmDonVi.xlsx';
                }catch(err){
                    console.log(err);
                }
            },
