<template>
    <div>
        <el-dialog title="Thông tin khen thưởng" :visible.sync="show" top="5vh" width="80%" :close-on-click-modal="false"
            append-to-body :close-on-press-escape="false" :before-close="handleClose">
            <form>
                <el-row :gutter="24">
                    <el-col :span="24">
                        <label class="table-name">Danh sách thông tin khen thưởng</label>
                    </el-col>
                    <el-col :span="24">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody v-else>
                                <tr v-for="(item,i) in list_khen_thuong" :key="i">
                                    ...
                                    <td>
                                        <el-select v-model="item.maKhenThuongGv" style="min-width:200px"
                                            filterable collapse-tags placeholder="Chọn"
                                            no-data-text="Không có dữ liệu"
                                            no-match-text="Không có dữ liệu phù hợp">
                                            <el-option v-for="item in list_khen_thuong_giao_vien"
                                    ...
                                    <td>
                                        <input type="text" class="form-control"
                                            v-model="item.soQuyetDinhKhenThuong" placeholder="Nhập...">
                                    </td>
                                    <td>
                                        <date-picker v-model="item.ngayKhenThuong" valueType="format"
                                    ...
                                    <!-- <td class="cg bt">
                                        ...
                                        <el-tooltip v-show="i+1==list_khen_thuong.length" content="Thêm"
                                            placement="top">
                                            ...
                                            <tr v-for="(item,i) in list_khen_thuong" :key="i">
                                                ...
                                                <td class="cg bt">
                                                    ...
                                                    <!-- <el-tooltip content="Xóa" placement="left">
                                                        <el-button plain size="mini" @click.prevent="xoaItemDtBd(i)"
                                                            icon="el-icon-delete" type="danger">
                                                        </el-button>
                                                    </el-tooltip>
                                                    <el-tooltip  v-show="i+1==list_khen_thuong.length" content="Thêm" placement="top">
                                                        <el-button plain size="mini" @click.prevent="themItemBdDt(i)"
                                                            icon="el-icon-plus" type="primary"> Thêm
                                                        </el-button>
                                                    </el-tooltip> -->
                                                </td>
            ...
            resetQt() {
                for (let i = 0; i < this.list_khen_thuong.length; i++) {
                    if (!this.list_khen_thuong[i].maKhenThuongGv) {
                        this.thongBao("error", "Thiếu khen thưởng");
                        return;
                    }
                }
                let obj = {
