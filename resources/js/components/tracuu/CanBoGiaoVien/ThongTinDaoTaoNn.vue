<template>
    <div>
        <el-dialog title="Quá trình ngoại ngữ" :visible.sync="show" top="5vh" width="80%" :close-on-click-modal="false"
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody v-else>
                                <tr v-for="(item,i) in list_dao_tao_ngoai_ngu" :key="i">
                                    ...
                                    <td>
                                        <date-picker v-model="item.NgayCap" valueType="format" value-type="DD/MM/YYYY"
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody v-else>
                                            <tr v-for="(item,i) in list_dao_tao_ngoai_ngu" :key="i">
                                                ...
                                                <td>
                                                    <el-select v-model="item.MaNgoaiNgu" style="min-width:200px"
                                                ...
                                                <td>
                                                    <el-select v-model="item.MaTrinhDoNgoaiNgu" style="min-width:200px"
                                                        ...
                                                        no-data-text="Không có dữ liệu"
                                                        no-match-text="Không có dữ liệu phù hợp">
                                                        <el-option v-for="item in list_trinh_do_ngoai_ngu"
                                                ...
                                                <td>
                                                    <input type="number" class="form-control"
                                                        v-model="item.DiemNgoaiNgu" placeholder="Nhập...">
                                                </td>
                                                <td>
