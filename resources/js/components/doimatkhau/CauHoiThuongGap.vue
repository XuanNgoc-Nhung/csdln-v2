    ...
    <div>
        <div class="row page-header">
            <div class="col-sm-6 text-uppercase">
                <a href="#">TRANG CHỦ</a><span><span class="kytu"> &raquo;</span> Hệ thống <span class="kytu"> &raquo;</span> Các câu hỏi thường gặp</span>
            </div>
        </div>
                    <div>
                            ...
                            <div style="margin:10px 0">
                                <div class="row" style="display:flex">
                                    ...
                                    <div class="col-md-3" style="align-self:flex-end">
                                        <button  v-if="thongtin.role==1" class="btn btn-info" @click.prevent="AddFaq()">Thêm câu hỏi mới</button>
                                    </div>
                                </div>
                            </div>
                            <!-- item -->
                            <div v-for="(item,i) in filterByTerm" :key=i class="panel panel-default"
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion"
                                            :href="idmenu+i"><b style="color:#01856B"><i>{{i+1}}.{{item.cauHoi}}</i></b></a>
                                    </h4>
                                </div>
                                <div :id="menu+i" class="panel-collapse collapse" :class="{ 'in' : i == 0 }">
                                    ...
                                    <div class="panel-footer">
                                        <a href="#" v-if="thongtin.role==1" @click.prevent="Update(item)" class="btn btn-primary">Chỉnh sửa</a>
                                        <a href="#"  v-if="thongtin.role==1" @click.prevent="Delete(item)" class="btn btn-danger">Xóa</a>
                                    </div>
                                </div>
                            </div>
                            <!-- **** -->
