<template>
    ...
    padding: 15px 0;">
                ...
                <div class="col-md-2" style="align-self:center">
                    ...
                    <el-select v-model="tieu_chi_he_thong" filterable placeholder="Chọn">
                        <el-option v-for="item in list_doi_tuong" :key="item.value" :label="item.name"
                            :value="item.value">
                        </el-option>
                    </el-select>
                </div>
                <div class="col-md-2" style="align-self:center">
                    ...
                    <el-select v-model="doiTuong" filterable placeholder="Chọn">
                        <el-option v-for="item in list_the_loai" :key="item.value" :label="item.name"
                            :value="item.value">
                        </el-option>
                    </el-select>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                <button class="btn btn-primary" v-on:click.prevent="AddFaq()">
                                    Thêm mới
                                </button>
                            </div>
                        </div>
            ...
            deleteUnit(e) {
                ...
                dialog.confirmDialog(
                    ...
                    () => {
                        ...
                        this
                            .$alertify
                            .error("Bạn không đủ quyền hạn để thực hiện chức năng này");
                        return;
                        let params = {
                            namHoc: this.namHoc
                        };
