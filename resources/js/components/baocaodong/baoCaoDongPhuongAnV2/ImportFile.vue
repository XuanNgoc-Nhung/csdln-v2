<template>
    <div id="modal_import_mk_ket_chuyen" ref="modal_import_mk_ket_chuyen" class="modal fade" style="z-index:2009">
                ...
                <div class="modal-body clearfix">
                    <div class="row">
                        <div style="height:200px; text-align:center">
                            ...
                            <el-button type="primary" size="mini" v-on:click="imPortFile()">Upload file
                            </el-button>
                        </div>
                    </div>
                </div>
        ...
        methods: {
            ...
            imPortFile() {
                if (this.selected_file == null) {
                    this.thongBao('error','Vui lòng chọn file');
                    return;
                }
                this.$confirm('Xác nhận upload file?', 'Thông báo', {
                        ...
                        api.postForm(this.uri, params, (data) => {
                            ...
                            if (data_import.rc == 0) {
                                ...
                                this.$emit('success', this.linkExcel);
                                    ...
                                    this.thongBao('error','Import file không thành công. Vui lòng thử lại')
                            }
                        });
                    })
                    .catch(_ => {});
