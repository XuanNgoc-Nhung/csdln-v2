<template>
    ...
    <el-dialog title="Thêm nhóm báo cáo" :visible.sync="hien_thi" fullscreen>

        <form @submit.prevent="submitForm">
            <div class="row" style="margin:15px 0">
                <div class="col-md-12 dts-col">
                    <label for="">Tên nhóm báo cáo</label>
                    <input type="text" class="form-control" v-model="thongTinNhomBaoCao.tenNhom" name="ten_bao_cao"
                ...
                <div class="col-md-5  dts-col">
                    ...
                    <eselect style="width:100%" multiple collapseTags @change="chonDonVi"
                        v-model="thongTinNhomBaoCao.donVi" no-match-text="Không tìm thấy bản ghi nào" name="don_vi"
                ...
                <div class="col-md-2 dts-col">
                    ...
                    <eselect style="width:100%" multiple v-model="thongTinNhomBaoCao.capHoc" @change="chonDonVi"
                ...
                <div class="col-md-5 dts-col">
                    ...
                    <eselect style="width:100%" multiple no-match-text="Không tìm thấy bản ghi nào"
                        v-model="thongTinNhomBaoCao.truongHoc" no-data-text="danh sách lựa chọn trống" name="truong_hoc"
                        v-validate="{required:true}" collapse-tags :placeholder="'Chọn'" filterable
        ...
        <div slot="footer" class="dialog-footer">
            <el-button type="primary" @click.prevent="submitForm" size="mini" style="margin: 0 5px">Thêm
                mới
            </el-button>
