<template>
    <div>
        <el-dialog title="Thêm thông tin báo cáo" :visible.sync="hien_thi" fullscreen>
                ...
                <div class="row" style="margin:15px 0">
                    ...
                    <div class="col-md-12 dts-col">
                        ...
                        <el-input clearable placeholder="Nhập..." v-model="filePath"
                            ...
                            <el-button plain type="success" size="mini" slot="append" @click="showUploadFile">
                                upload file
                            </el-button>
                        </el-input>
                        <span v-if="show_msg"><span class="text-danger"
                    ...
                    <div class="col-md-6 dts-col">
                        ...
                        <el-select multiple name="the" v-validate="{required:true}" v-model="thongTinNhomBaoCao.Tags"
                    ...
                    <div class="col-md-3 dts-col">
                        ...
                        <eselect name="doi_tuong_lap" v-validate="{required:canDoiTuong ? true : false}"
                            ...
                            :placeholder="'Chọn'" filterable :data="list_doi_tuong_lap" :fields="['name','value']" />
                        <span v-if="show_msg"><span class="text-danger"
                                v-show="errors.has('doi_tuong_lap')">{{ errors.first('doi_tuong_lap') }}</span></span>
                    </div>
                    <div class="col-md-5  dts-col">
                        <label for="">Đơn vị</label>
                        <eselect name="ma_don_vi" v-validate="{required:true}" style="width:100%" multiple collapseTags @change="chonDonVi"
                    ...
                    <div class="col-md-2 dts-col">
                        ...
                        <eselect name="cap_hoc" v-validate="{required:true}" style="width:100%" multiple v-model="thongTinNhomBaoCao.capHoc" @change="chonDonVi"
                    ...
                    <div class="col-md-5 dts-col">
                        ...
                        <eselect style="width:100%" multiple no-match-text="Không tìm thấy bản ghi nào"
                            v-model="thongTinNhomBaoCao.truongHoc" no-data-text="danh sách lựa chọn trống" collapse-tags
            ...
            customMessage() {
                const dict = {
                    custom: {
                        ...
                        doi_tuong_lap: {
                            required: () => 'Đối tượng lặp không thể trống'
                        },
                        ma_don_vi: {
                            required: () => 'Đơn vị không thể trống'
                        },
