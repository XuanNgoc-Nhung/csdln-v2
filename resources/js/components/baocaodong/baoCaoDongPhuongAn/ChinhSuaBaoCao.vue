<template>
    <div>
        <div id="modal_chinh_sua_bao_cao" ref="modal_chinh_sua_bao_cao" class="modal fade">
            <div class="modal-dialog-fullscreen">
                <form @submit.prevent="submitForm">
                    <div class="modal-content-fullscreen">
                        <div class="modal-header-fullscreen">
                            <h5 class="modal-title text-uppercase">Chỉnh sửa báo cáo</h5>
                        </div>
                        <div class="modal-body-fullscreen">
                            <div class="row" style="margin:15px 0">
                                <div class="col-md-6 dts-col">
                                    <label for="">Tên báo cáo</label>
                                    <input type="text" class="form-control" v-model="thongTinBaoCao.name"
                                ...
                                <div class="col-md-6 dts-col">
                                    ...
                                    <input type="text" class="form-control" v-model="thongTinBaoCao.description"
                                        name="mo_ta" placeholder="Nhập..." v-validate="{required:true}">
                                    <span v-if="show_msg"><span class="text-danger"
                                ...
                                <div class="col-md-12 dts-col">
                                    ...
                                    <el-input clearable placeholder="Nhập..."
                                        ...
                                        <el-button size='mini' plain type="success" slot="append"
                                ...
                                <div class="col-md-6 dts-col">
                                    ...
                                    <el-select multiple name="the" v-validate="{required:true}"
                                        v-model="thongTinBaoCao.tags" filterable allow-create default-first-option
                                        placeholder="Nhập..."
                                ...
                                <div class="col-md-3 dts-col">
                                    <label class="typo__label">Đối tượng lặp <span v-show="canDoiTuong"
                                            style="color:#DC0101">*</span> </label>
                                    <eselect name="doi_tuong_lap" v-validate="{required:canDoiTuong ? true : false}"
                                        style="width:100%" v-model="thongTinBaoCao.doiTuongLap" collapseTags
                                ...
                                <div class="col-md-5 dts-col">
                                    ...
                                    <eselect style="width:100%" v-model="thongTinBaoCao.donViList" @change="ChonDonVi"
                                        no-match-text="Không tìm thấy bản ghi nào"
                                        no-data-text="danh sách lựa chọn trống" :placeholder="'Chọn'" filterable
                                        :data="danh_sach_don_vi_duoc_phep_ot" :fields="['tenDonVi','maDonVi']" />
                                </div>
                                <div class="col-md-2 dts-col">
                                    <label for="">Cấp học</label>
                                    <eselect style="width:100%" multiple v-model="thongTinBaoCao.capHocList"
                                        @change="ChonDonVi" collapseTags no-match-text="Không tìm thấy bản ghi nào"
                                        no-data-text="danh sách lựa chọn trống" :placeholder="'Chọn'" filterable
                                        :data="danh_sach_cap_hoc_duoc_phep_ot" :fields="['name','id']" />
                                </div>
                                <div class="col-md-5 dts-col">
                                    <label for="">Trường học</label>
                                    <eselect style="width:100%" v-model="thongTinBaoCao.maTruongList" multiple
                        ...
                        <div class="modal-footer-fullscreen">
                            <el-button type="warning" size="mini" @click.prevent="submitForm" style="margin: 0 5px">
                                Chỉnh sửa
                            </el-button>
        ...
        <div v-if="hien_thi_upload_file">
            <Import @close="hien_thi_upload_file=false" @success="ganLink($event)"></Import>
        </div>
    </div>
</template>
<script>
