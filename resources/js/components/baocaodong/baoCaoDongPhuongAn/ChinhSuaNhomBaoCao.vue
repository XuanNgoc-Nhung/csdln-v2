<template>
    <div id="modal_chinh_sua_nhom_bao_cao" ref="modal_chinh_sua_nhom_bao_cao" class="modal fade">
        <div class="modal-dialog-fullscreen">
            <form @submit.prevent="submitForm">
                <div class="modal-content-fullscreen">
                    <div class="modal-header-fullscreen">
                        <h5 class="modal-title text-uppercase">Chỉnh sửa nhóm báo cáo</h5>
                    </div>
                    <div class="modal-body-fullscreen">
                        <div class="row" style="margin:15px 0">
                            <div class="col-md-12 dts-col">
                                <label for="">Tên nhóm báo cáo</label>
                                <input type="text" class="form-control" v-model="thongTinNhomBaoCao.groupName"
                            ...
                            <div class="col-md-5  dts-col">
                                ...
                                <eselect style="width:100%" multiple collapseTags @change="chonDonVi"
                                    v-model="thongTinNhomBaoCao.donViList" no-match-text="Không tìm thấy bản ghi nào"
                            ...
                            <div class="col-md-2 dts-col">
                                ...
                                <eselect style="width:100%" multiple v-model="thongTinNhomBaoCao.capHocList"
                    ...
                    <div class="modal-footer-fullscreen">
                        <el-button type="warning" size="mini" @click.prevent="submitForm" style="margin: 0 5px">Chỉnh
                            sửa
                        </el-button>
