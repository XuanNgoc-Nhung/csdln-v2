<template>
    <div>
        ...
        <el-dialog title="Chỉnh sửa tiêu chí" width="90%" top="5vh" :visible.sync="show_edit" @close="dongModal">
            <el-row :gutter="20">
                <el-col :span="6">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button size="mini" type="primary" @click="confirmThemMoi">Chỉnh sửa</el-button>
            </span>
        </el-dialog>
    </div>
</template>
<script>
    ...
    export default {
        ...
        watch: {
            ...
            item: function (val) {
                if (val) {
                    console.log("Dữ liệu chỉnh sủa thay đổi:")
                    console.log(val)
                    let data = val;
            ...
            confirmThemMoi() {
                ...
                this.$confirm('Xác nhận chỉnh sửa?', 'Thông báo', {
                    ...
                    .then(_ => {
                        ...
                        rest_api.post("/csdlgd-analytic-api/external-data/update", params, response => {
                            ...
                            if (response.statusText == 'OK') {
                                ...
                                this.thongBao('error', 'Chỉnh sửa thất bại')
                            }
                        });
                    })
                    .catch(_ => {});
