    ...
    addRule: function addRule() {
      ...
      var child = {
        ...
        query: {
          ...
          type: typeof this.selectedRule.operands === "undefined" ? this.selectedRule.kieuDuieu : this.selectedRule.operands[0],
          value: null
        }
    ...
    addGroup: function addGroup() {
      ...
      if (this.depth < this.maxDepth) {
        updated_query.children.push({
          ...
          query: {
            condition: this.labels.matchTypes[0].id,
            children: []
          }
        });
        this.$emit('update:query', updated_query);
