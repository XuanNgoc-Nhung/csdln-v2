<template>
    ...
    <div id="modal_sua_nhom_tieu_chi" ref="modal_sua_nhom_tieu_chi" class="modal fade">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-uppercase">Sửa nhóm tiêu chí mới</h4>
                </div>
    ...
    export default {
        ...
        watch: {
            show: function (newVal, oldVal) {
                ...
                if (newVal) {
                    this.reset();
                    this.move_data(this.v_obj_tieu_chi);
                    $("#modal_sua_nhom_tieu_chi").modal();
                } else {
                    $("#modal_sua_nhom_tieu_chi").modal('hide');
                }
            },
        ...
        mounted: function () {
            console.log("mounted !!!!!");
            $(this.$refs.modal_sua_nhom_tieu_chi).on("hidden.bs.modal", this.close);
        },
