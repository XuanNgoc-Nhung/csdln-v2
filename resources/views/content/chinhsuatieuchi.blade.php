...
<body>
    <div class="container">
        <div class="show_add" style="display:block">
            <div class="row">
                <div class="col-md-12">
                    <h4 style="margin:0">CHỈNH SỬA TIÊU CHÍ</h4>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <select id="doiTuongApDung" class="imputTimKiem imputTimKiemDoiTuong form-control">
                            ...
                            <option value="LopTruongHocHoc">Trường học, điểm trường</option>
            ...
            <div class="row" style="padding:20px">
                <div class="col-md-12 text-center">
                    <button id="btn-themTieu-Chi" class="btn btn-primary">Chỉnh sửa</button>
                </div>
            </div>
        </div>
        <div class="show_done" style="display:none">
            <div class="row-">
                <div class="col-md-12 text-center">
                    <p>Chỉnh sửa tiêu chí thành công. Bạn có thể đóng cửa sổ trình duyệt này!</p>
                    <button id="hienThiThemTieuChi" class="btn btn-success">Chỉnh sửa lại</button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function layThongTinTieuChi(e) {
            ...
            $.ajax({
                ...
                console.error("Thông tin tiêu chí:")
                console.log(ketqua);
                if (ketqua.rc == 0) {
                    thongTinTieuChi = ketqua.item;
        ...
        function ganDuLieuTieuChi(e) {
            ...
            if (thong_tin.doiTuong != 'Custom') {
                ...
                // Check nếu không phải là tiêu chí ngoài thì mới gán giá trị cho querybuider và phương pháp tính
...
<script src="quanlytieuchi/chinhsuatieuchi.js"></script>
