        ...
        <nav class="main-header navbar navbar-expand ">
            ...
            <div class="" style="width:100%;">
                <div class="row" style="">
                    ...
                    <div class="col-sm-3">
                        <select class="custom-select donViThongKe form-control form-control-border selectpicker"
                    ...
                    <div class="col-sm-2">
                        <select class="custom-select capHocThongKe form-control form-control-border selectpicker"
                            data-show-subtext="true" data-live-search="true">
                            <option>Chọn cấp học</option>
                            <option value="5">Mẫu giáo</option>
                            <option value="45">Mầm non</option>
                            <option value="5">Nhà trẻ</option>
                            <option value="1">Tiểu học</option>
                            <option value="2">Trung học cơ sở</option>
                            <option value="3">Trung học phổ thông</option>
                            <option value="6">Giáo dục thường xuyên</option>
                        </select>
                    </div>
                    <div class="col-sm-2">
                        <select class="custom-select namHocThongKe form-control form-control-border selectpicker"
                            data-show-subtext="true" data-live-search="true">
                    ...
                    <div class="col-sm-2">
                        <button type="button" id="thongKeDuLieuBieuDo" class="btn btn-block btn-success">Thống
                            kê</button>
                    </div>
        ...
        <aside class="main-sidebar elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="pages/widgets.html" class="{{ Request::is('dashboard') ? 'nav-link active' : 'nav-link' }}">
                            ...
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-danger">
                                    <div class="inner">
                                        ...
                                        <h2 id='soLuongHocSinhNghiHoc'>0</h2>
                                    </div>
                                    <div class="icon">
